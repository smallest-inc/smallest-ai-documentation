...
DOCS_TO_AUDIT_BY_SERVICE: dict[str, list[str]] = {
    "pulse-stt-ws": [
        ...
        "`fern/products/waves/pages/api-references/pulse-stt-ws.mdx`",
        "`fern/products/waves/pages/speech-to-text/realtime/response-format.mdx`",
        "`fern/products/waves/pages/speech-to-text/features/word-boosting.mdx`",
