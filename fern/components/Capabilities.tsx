...
const ICONS: Record<string, React.ReactNode> = {
  ...
  "spell-check": (
    <>
      <path d="M2.25 6a3 3 0 013-3h13.5a3 3 0 013 3v3.75a.75.75 0 01-1.5 0V6a1.5 1.5 0 00-1.5-1.5H5.25A1.5 1.5 0 003.75 6v3.75a.75.75 0 01-1.5 0V6z" />
      <path d="M7.5 9a3 3 0 013-3h.75a.75.75 0 010 1.5h-.75a1.5 1.5 0 00-1.5 1.5v3a.75.75 0 01-1.5 0V9zM4.5 13.5a.75.75 0 01.75.75v.75c0 .414.336.75.75.75h.75a.75.75 0 010 1.5h-.75a2.25 2.25 0 01-2.25-2.25v-.75a.75.75 0 01.75-.75zM21.53 13.97a.75.75 0 010 1.06l-5 5a.75.75 0 01-1.06 0l-2.5-2.5a.75.75 0 111.06-1.06l1.97 1.97 4.47-4.47a.75.75 0 011.06 0z" />
    </>
  ),
  "user-music": (
    <>
      <path d="M12 12a4 4 0 100-8 4 4 0 000 8zM3 19.5a8 8 0 0114-5.29V14a2 2 0 002 2h2a2 2 0 002-2V8a2 2 0 00-2-2h-.5a8.5 8.5 0 010-1H21a3 3 0 013 3v8a3 3 0 01-3 3h-2a3 3 0 01-3-3v-.21A6.5 6.5 0 014.5 19.5H3z" />
    </>
  ),
};
