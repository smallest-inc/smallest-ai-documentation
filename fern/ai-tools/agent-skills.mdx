...
<Note>
  Skills complement the [MCP server](/atoms/mcp/getting-started/quick-start) — MCP gives your agent live access to your Atoms platform data (agents, calls, analytics), while skills give it API expertise to write correct Waves code.
</Note>
