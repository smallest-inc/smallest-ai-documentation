...
<AccordionGroup>
  <Accordion title="Setup API Key" icon="key">
  ...
  <Accordion title="Text to Speech" icon="volume-high">
  ...
  <Accordion title="Speech to Speech" icon="waveform-lines">
  ...
  <Accordion title="LLM (Electron)" icon="robot">
  ...
  <Accordion title="Voice Agents" icon="headset">
