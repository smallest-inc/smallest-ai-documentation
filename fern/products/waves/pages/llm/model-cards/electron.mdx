...
**Jump to:** [Benchmarks](#performance--benchmarks) · [Supported Languages](#supported-languages) · [API Reference](/models/api-reference/llm-chat-completions/electron-chat-completions) · [Pricing & Throughput](#throughput-latency--pricing) · [Quickstart](/models/documentation/llm-electron/quickstart)
...
Both limits enforce strictly — over either cap returns `HTTP 429`. See [Concurrency & Limits](/models/api-reference/concurrency-and-limits) for full rate-limit semantics.
