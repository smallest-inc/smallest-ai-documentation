...
Everything else - request shape, response shape, streaming format, error envelope - matches OpenAI's. See [Migrate from OpenAI](/models/documentation/llm-electron/migrate-from-openai) for the side-by-side code diff.
