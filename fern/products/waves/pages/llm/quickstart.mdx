...
<CardGroup cols={2}>
  ...
  <Card title="Prefix Caching" icon="bolt" href="/models/documentation/llm-electron/prefix-caching">
    Cached input tokens are billed at a discounted rate. Structure your prompts to hit the cache.
  </Card>
