...
1. **Go to the Smallest AI Platform**  
   Navigate to [smallest.ai](https://app.smallest.ai/waves/voice-cloning) and click on **Create New**. In the modal that appears, select **Professional Voice Clone**. This will direct you to the setup page:
