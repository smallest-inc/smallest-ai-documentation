...
To access our API, you need an API key. You can find your API key by visiting [Smallest AI Console](https://app.smallest.ai/dashboard/settings).
...
For more details, visit our [API Documentation](/waves/v-3-0-1/documentation/getting-started/authentication).
