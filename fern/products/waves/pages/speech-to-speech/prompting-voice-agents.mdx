...
- [Tool calling](/models/speech-to-speech/tool-calling) - the mechanics of declaring and executing tools
- [Turn detection & barge-in](/models/speech-to-speech/turn-detection-barge-in) - what the model handles vs what your prompt should influence
