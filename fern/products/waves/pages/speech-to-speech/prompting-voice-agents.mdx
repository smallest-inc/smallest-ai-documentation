...
- [Tool calling](/models/documentation/speech-to-speech-hydra/tool-calling) — the mechanics of declaring and executing tools
- [Turn detection & barge-in](/models/documentation/speech-to-speech-hydra/turn-detection-barge-in) — what the model handles vs what your prompt should influence
