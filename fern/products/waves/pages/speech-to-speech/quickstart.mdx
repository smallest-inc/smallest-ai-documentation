...
<CardGroup cols={2}>
  ...
  <Card title="Audio I/O" icon="waveform-lines" href="/models/speech-to-speech/audio-i-o">
    Input PCM16, output rate negotiation, browser AudioWorklet.
  </Card>
  <Card title="Turn detection & barge-in" icon="wave-square" href="/models/speech-to-speech/turn-detection-barge-in">
