...
<Tabs>
  ...
  <Tab title="Node.js">
    ...
    const url = `wss://api.smallest.ai/waves/v1/s2s?model=hydra-v1.1&api_key=${process.env.SMALLEST_API_KEY}`;
  ...
  <Tab title="Browser">
    ...
    const ws = new WebSocket(
      `wss://api.smallest.ai/waves/v1/s2s?model=hydra-v1.1&api_key=${apiKey}`
    );
