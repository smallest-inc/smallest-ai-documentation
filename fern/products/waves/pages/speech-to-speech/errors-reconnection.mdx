...
See [WebSocket connection](/models/speech-to-speech/web-socket-connection#close-codes) for the full close-code reference.
...
- [WebSocket connection](/models/speech-to-speech/web-socket-connection) - close codes and idle timeout
- [Tool calling](/models/speech-to-speech/tool-calling) - `tool_response_timeout` deep dive
