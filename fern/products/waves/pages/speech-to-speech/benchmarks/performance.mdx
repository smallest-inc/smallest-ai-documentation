...
See [Metrics Overview](/models/speech-to-speech/benchmarks/metrics-overview) for the exact definitions.
...
<CardGroup cols={2}>
  <Card title="Metrics Overview" icon="ruler" href="/models/speech-to-speech/benchmarks/metrics-overview">
