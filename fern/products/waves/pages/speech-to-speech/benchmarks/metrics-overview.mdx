...
This page defines what each metric on the [Performance](/models/speech-to-speech/benchmarks/performance) page actually measures.
...
<CardGroup cols={2}>
  <Card title="Performance" icon="gauge-high" href="/models/speech-to-speech/benchmarks/performance">
