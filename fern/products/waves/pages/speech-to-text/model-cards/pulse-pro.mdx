...
**Jump to:** [Benchmarks](#performance--benchmarks) · [API Reference](/api-reference/models/speech-to-text/transcribe) · [Pre-recorded Quickstart](/models/speech-to-text/pre-recorded/quickstart)
