...
**Jump to:** [Benchmarks](#performance--benchmarks) · [API Reference](/models/api-reference/speech-to-text/transcribe) · [Pre-recorded Quickstart](/models/documentation/speech-to-text-pulse/pre-recorded/quickstart)
