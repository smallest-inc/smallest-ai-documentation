...
<CardGroup cols={2}>
  <Card title="Real-Time Transcription" icon="broadcast-tower" href="/models/documentation/speech-to-text-pulse/realtime-web-socket/quickstart">
  ...
  <Card title="Model card" icon="id-card" href="/models/model-cards/speech-to-text/pulse">
