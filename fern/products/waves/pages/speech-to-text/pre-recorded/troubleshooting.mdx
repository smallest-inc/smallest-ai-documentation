...
- Normalize and denoise audio before uploading (see [best practices](/models/speech-to-text/pre-recorded/best-practices)).
...
For 401, 403, 429, 500, and the `NoSuchKey` storage error (common on pre-recorded uploads), see the [Error reference](/models/troubleshooting/error-reference).
