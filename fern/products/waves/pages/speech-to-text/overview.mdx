...
<Card title="Quickstart" icon="rocket" href="/models/speech-to-text/quickstart">
...
<CardGroup cols={2}>
  <Card title="Pre-Recorded" icon="file-audio" href="/models/speech-to-text/pre-recorded/quickstart">
  ...
  <Card title="Real-Time" icon="broadcast-tower" href="/models/speech-to-text/realtime-web-socket/quickstart">
