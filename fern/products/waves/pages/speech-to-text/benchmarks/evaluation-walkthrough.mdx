...
Our evaluation guide outlines a repeatable process: choose representative audio, generate transcripts, compute WER/CER/latency, and document findings. The ready-to-run snippets below call the [Pulse pre-recorded REST endpoint](/models/api-reference/speech-to-text/transcribe) directly so you can audit the methodology and adapt it to any HTTP client.
