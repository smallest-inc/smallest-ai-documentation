...
L4 is the recommended production GPU and runs at lower throughput than the L40S reference. See [Cloud deployment](/self-host/docker-setup/stt-deployment/cloud-deployment) for sizing.
