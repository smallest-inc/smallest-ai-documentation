...
| :--- | :---: | :---: | :---: | :--- |
| **Smallest Pulse** | 5.55% | 6.06% | 5.81% | Yes |
...
These four languages stream from `wss://api.us.smallest.ai/waves/v1/stt/live?model=pulse` only (US region). See the [Pulse model card](/models/model-cards/speech-to-text/pulse#supported-languages--streaming) for the region-routing details.
...
- [Metrics Overview](/models/documentation/speech-to-text-pulse/benchmarks/metrics-overview)
- [Evaluation Walkthrough](/models/documentation/speech-to-text-pulse/benchmarks/evaluation-walkthrough)
- [Best Practices](/models/documentation/speech-to-text-pulse/pre-recorded/best-practices)
