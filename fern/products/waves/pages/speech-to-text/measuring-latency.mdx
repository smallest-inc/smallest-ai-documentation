...
- [Realtime response format](/models/speech-to-text/realtime-web-socket/response-format) - wire signals (`is_final`, `words`, `finalize`) this page measures against
- [Realtime quickstart](/models/speech-to-text/realtime-web-socket/quickstart) - minimum working WebSocket client
- [Pre-recorded quickstart](/models/speech-to-text/pre-recorded/quickstart) - source endpoint for the RTFx code
