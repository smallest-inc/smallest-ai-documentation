...
For streaming synthesis via WebSocket or SSE, see [Streaming TTS](/models/text-to-speech/streaming).
...
| `pronunciation_dicts` | array | - | List of [pronunciation dictionary](/models/text-to-speech/pronunciation-dictionaries) IDs |
...
For real-time streaming where audio starts playing before generation completes, see [Streaming TTS](/models/text-to-speech/streaming).
