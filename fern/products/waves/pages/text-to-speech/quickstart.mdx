...
<CardGroup cols={2}>
  ...
  <Card title="Voices & Languages" icon="users" href="/models/text-to-speech/voices-languages">
    Browse 217 voices across 12 languages on the standard pool - English, Hindi, Spanish, and 9 Indian languages.
  </Card>
  <Card title="Streaming TTS" icon="broadcast-tower" href="/models/text-to-speech/streaming">
