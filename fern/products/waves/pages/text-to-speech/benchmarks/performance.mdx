...
<Note>
For Pronunciation and WER, the residual gap on Lightning v3.1 (Standard) is concentrated in proper-noun rendering. Use a [pronunciation dictionary](/models/text-to-speech/pronunciation-dictionaries) to pin names, brands, and acronyms; with the dictionary applied, both metrics close to parity.
</Note>
...
- [Metrics Overview](/models/text-to-speech/benchmarks/metrics-overview)
- [Lightning v3.1 model card](/models/model-cards/text-to-speech/lightning-v-3-1)
