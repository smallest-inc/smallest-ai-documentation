...
The three fragments above are buffered and joined into one continuous generation instead of three separately-paced ones, because they share `context_id: "call-1"`.
