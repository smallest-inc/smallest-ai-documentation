...
Yes. Pass `model: lightning-v3.1-pro` to the [voice-cloning API](/models/documentation/voice-cloning/instant-clone-api) to clone onto the Pro pool, then use the resulting `voice_id` with TTS `model: lightning_v3.1_pro`. The default is `lightning-v3.1`.
</Accordion>
