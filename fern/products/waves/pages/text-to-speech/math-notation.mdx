...
- [`number_pronunciation_language`](/api-reference/models/text-to-speech/tts) sets the language for spoken numeric content, including math operator words.
- [Pronunciation Dictionaries](/models/text-to-speech/pronunciation-dictionaries) let you override specific tokens directly.
