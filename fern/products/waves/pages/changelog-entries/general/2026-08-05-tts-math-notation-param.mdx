...
Full lexicon, matching rules, known limitations (product dimensions, `24x7` idiom, vehicle-reg codes), and EU-language localizations on the new [Math notation](/models/documentation/text-to-speech-lightning/math-notation) page.
