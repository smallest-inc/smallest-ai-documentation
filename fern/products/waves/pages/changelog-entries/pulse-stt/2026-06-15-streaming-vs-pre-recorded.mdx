...
- **Overview page** (`/models/documentation/speech-to-text-pulse/overview`): split the single Supported Languages table into two — Streaming (Real-Time, WebSocket) and Non-Streaming (Pre-Recorded, HTTP). Same 39-language set in both, matching the [Pulse model card](/models/model-cards/speech-to-text/pulse).
