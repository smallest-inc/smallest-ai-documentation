...
Fixed two things the [Speaker diarization](/models/documentation/speech-to-text-pulse/features/diarization) page and the streaming WS spec got wrong, plus tightened the page for developers rather than marketing.
