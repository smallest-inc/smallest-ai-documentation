...
- Added `from_finalize`, `transcript`, `full_transcript`, `language`, and `languages` fields to the `TranscriptionEvent` response schema (they were missing from the spec despite being emitted by the server).
