...
If your code still calls `wss://api.smallest.ai/waves/v1/lightning/get_text`, migrate to Pulse STT - the request shape is similar; see the [Pulse STT quickstart](/models/speech-to-text/quickstart) and the [Pulse WebSocket reference](/api-reference/models/speech-to-text/speech-to-text).
