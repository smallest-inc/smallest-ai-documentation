...
Full parameter reference, buffering rules, and a worked example on the new [Continuations](/models/documentation/text-to-speech-lightning/continuations) page.
