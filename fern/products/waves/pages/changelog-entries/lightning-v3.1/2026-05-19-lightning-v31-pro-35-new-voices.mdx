...
- The full updated voice list is available via the [Get Voices endpoint](/api-reference/models/text-to-speech/get-waves-voices) - filter to `model=lightning_v3.1_pro` to see only the Pro catalog.
