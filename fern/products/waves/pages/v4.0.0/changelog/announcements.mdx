...
<Update label="January 2026">
    ...
    Experience the new capabilities of Lightning v3.1 on our [platform](https://app.smallest.ai/dashboard/text-to-speech?utm_source=documentation&utm_medium=changelog) or via the [API](/waves/documentation/api-references/lightning-v3.1).
</Update>
...
<Update label="December 2024">
    ...
    Experience the new capabilities of Lightning Large via our [Platform](https://app.smallest.ai/dashboard/text-to-speech) or the [API](/v3.0.1/content/api-references/lightning).
</Update>
...
<Update label="November 2024">
    ...
    The voices available on waves platform are available via the [Smallest AI API](/v3.0.1/content/api-references/lightning)
</Update> 
...
<Update label="October 2024">
    ...
    You can access lightning via the [Smallest AI API](/v3.0.1/content/api-references/lightning)
</Update>
