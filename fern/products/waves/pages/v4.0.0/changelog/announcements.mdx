...
<Update label="January 2026">
    ...
    Experience the new capabilities of Lightning v3.1 on our [platform](https://atoms.smallest.ai/dashboard/text-to-speech?utm_source=documentation&utm_medium=changelog) or via the [API](/waves/api-reference/lightning-v3.1).
</Update>
