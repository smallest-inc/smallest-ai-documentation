...
<Update label="January 2026">
    ...
    Experience the new capabilities of Lightning v3.1 on our [platform](https://app.smallest.ai/dashboard/text-to-speech?utm_source=documentation&utm_medium=changelog) or via the [API](/waves/api-reference/lightning-v3.1).
</Update>
...
<Update label="December 2024">
    ...
    Experience the new capabilities of Lightning Large via our [Platform](https://waves.smallest.ai) or the [API](/waves/v-3-0-1/documentation/api-references/lightning).
</Update>
...
<Update label="November 2024">
    ...
    The voices available on waves platform are available via the [Waves API](/waves/v-3-0-1/documentation/api-references/lightning)
</Update> 
...
<Update label="October 2024">
    ...
    Read more about lightning in our release post [here](https://smallest.ai).

    You can access lightning via the [Waves API](/waves/v-3-0-1/documentation/api-references/lightning)
</Update>
