...
<Update label="January 2026">
    ...
    Experience the new capabilities of Lightning v3.1 on our [platform](https://app.smallest.ai/waves/studio/create?utm_source=documentation&utm_medium=changelog) or via the [API](/v4.0.0/content/api-references/lightning-v3.1).
</Update>
