...
<Update label="January 2026">
    ...
    Experience the new capabilities of Lightning v3.1 on our [platform](https://atoms.smallest.ai/dashboard/text-to-speech?utm_source=documentation&utm_medium=changelog) or via the [API](/v4.0.0/content/api-references/lightning-v3.1).
</Update>
...
<Update label="December 2024">
    ...
    Experience the new capabilities of Lightning Large via our [Platform](https://waves.smallest.ai) or the [API](/v3.0.1/content/api-references/lightning).
</Update>
