...
# Creating an Instant Voice Clone  
 ...
 1️. **Go to the Smallest AI Platform**  
   - Navigate to the **[platform](https://waves.smallest.ai/voice-clone?utm_source=documentation&utm_medium=voice-cloning)** and click on **Create New**.  
 ...
 2️. **Upload Your Clean Reference Audio**  
   ...
   - Follow the recommended **[best practices](/waves/v-3-0-1/documentation/best-practices/voice-cloning-best-practices)** to maximize quality.  
