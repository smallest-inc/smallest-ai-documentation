...
description: "Convert speech to text using file upload with the Lightning STT POST API"
openapi: "POST /waves/v1/lightning/get_text"
---
...
Both methods use our Lightning STT model with automatic language detection across 30+ languages.
...
curl --request POST \
  --url "https://api.smallest.ai/waves/v1/lightning/get_text?language=en&word_timestamps=true&diarize=true&age_detection=true&gender_detection=true&emotion_detection=true" \
...
url = "https://api.smallest.ai/waves/v1/lightning/get_text"
headers = {
...
const response = await fetch(
  `https://api.smallest.ai/waves/v1/lightning/get_text?${params}`,
  {
    method: "POST",
    headers: {
...
The Lightning STT model supports **automatic language detection** and transcription across **30+ languages**.
