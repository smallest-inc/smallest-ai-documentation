...
To access our API, you need an API key. You can generate your API key by visiting the [Smallest AI Console](https://app.smallest.ai/dashboard/settings?utm_source=documentation&utm_medium=api-references).
