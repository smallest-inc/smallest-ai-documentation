...
- Each key tracks usage against your account quota — see [Concurrency and Limits](/models/api-reference/api-references/concurrency-and-limits)
...
For rate limits and concurrency, see [Concurrency and Limits](/models/api-reference/api-references/concurrency-and-limits).
