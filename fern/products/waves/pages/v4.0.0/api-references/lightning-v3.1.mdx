...
- **Multi-Language**: 22 languages plus auto-detect. Indian (`en`, `hi`, `mr`, `kn`, `ta`, `bn`, `gu`, `te`, `ml`, `pa`, `or`), European (`de`, `fr`, `es`, `it`, `pl`, `nl`, `ru`, `sv`, `pt`), MENA (`ar`, `he`), or `auto` for code-switching
