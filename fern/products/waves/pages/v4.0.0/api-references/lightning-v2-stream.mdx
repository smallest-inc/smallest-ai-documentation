---
title: "Lightning v2 SSE"
sidebarTitle: "Lightning v2 SSE (Legacy)"
description: "Stream speech for given text using the Lightning v2 SSE API"
openapi: "POST /waves/v1/lightning-v2/stream"
---

<Badge color="orange">Legacy</Badge> Lightning v2 is a legacy model. For new projects, we recommend [Lightning v3.1 SSE](/waves/documentation/api-references/lightning-v3.1-stream).
