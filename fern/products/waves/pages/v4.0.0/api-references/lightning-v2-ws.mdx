...
sidebarTitle: "Lightning v2 WS (Legacy)"
...
asyncapi: "/asyncapi-spec/lightning-v2-ws.json /waves/v1/lightning-v2/get_speech/stream"
---

<Badge color="orange">Legacy</Badge> Lightning v2 is a legacy model. For new projects, we recommend [Lightning v3.1 WebSocket](/waves/documentation/api-references/lightning-v3.1-ws).
