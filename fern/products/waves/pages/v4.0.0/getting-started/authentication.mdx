...
>For local development, export your key as an environment variable. 
>For e.g., `export SMALLEST_API_KEY=...` instead of hardcoding it.
...
print(f"Available Voices: {client.get_voices(model='lightning-v3.1')}")
```
</CodeGroup>