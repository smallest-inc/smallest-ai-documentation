...
<Steps>
  <Step title="Get your API key">
    Sign up at the [platform](https://app.smallest.ai/dashboard/settings?utm_source=documentation&utm_medium=getting-started) and create an API key from your dashboard.
  </Step>
...
<CardGroup cols={4}>
  <Card title="API Reference" icon="code" href="/waves/api-reference/api-reference/voices/get-waves-voices">
