...
<CardGroup cols={1}>
  <Card title="Lightning v3.1" icon="sparkles" href="/waves/model-cards/text-to-speech/lightning-v-3-1">
    <Badge color="green">Latest Release</Badge> A 44 kHz model delivering natural, expressive, and realistic speech. Supports voice cloning with ultra-low latency. 12 languages plus `auto`-detect with mid-sentence code-switching.
  </Card>
</CardGroup>
