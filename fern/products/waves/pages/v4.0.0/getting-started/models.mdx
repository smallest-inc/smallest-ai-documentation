...
<CardGroup cols={2}>
  ...
  <Card title="Lightning v3.1" icon="sparkles" href="/waves/documentation/text-to-speech/model-cards/lightning-v3-1">
...
<CardGroup cols={2}>
  <Card title="Pulse STT" icon="microphone" href="/waves/documentation/speech-to-text/model-cards/pulse">
    Low-latency speech recognition for real-time and pre-recorded transcription.
    Automatic language detection across 32+ languages.
  </Card>
</CardGroup>
...
| [**lightning-v3.1**](/waves/documentation/text-to-speech/model-cards/lightning-v3-1)  | 44 kHz model, natural expressive speech, ultra-low latency, supports voice cloning. | `English` <br/> `Hindi` <br/> `Tamil` <br/> `Spanish`                                                                                                                                                                                                                                            |
