...
<CardGroup cols={3}>
  ...
  <Card title="Lightning" icon="waveform-lines">
    Streaming TTS. 44.1 kHz audio, ~200 ms TTFB, 12 TTS languages including Indic.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Lightning Streaming" icon="bars-staggered" href="/waves/documentation/text-to-speech-lightning/stream-tts">
    Streaming TTS setup.
  </Card>
  <Card title="Electron Tool Calling" icon="screwdriver-wrench" href="/waves/documentation/llm-electron/tool-calling">
