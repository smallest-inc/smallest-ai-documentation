...
<Tip>
If you want a full voice-agent platform with built-in telephony, campaigns, knowledge base, and call analytics, see [**Atoms**](/voice-agents/platform/get-started/quick-start) — it's built on top of this exact stack. Use this cookbook when you want to build the pipeline yourself.
</Tip>
...
<CardGroup cols={3}>
  <Card title="Pulse" icon="microphone">
    Streaming STT. Audio chunks in → partial + final transcripts out. Supports 21 streaming languages with regional aggregator auto-detection.
  </Card>
  ...
  <Card title="Lightning" icon="waveform-lines" href="/models/model-cards/text-to-speech/lightning-v-3-1">
    ...
    async with websockets.connect(
        ...
        async def recv():
            async for msg in ws:
                ...
                # See /models/documentation/speech-to-text-pulse/realtime-web-socket/response-format
...
<CardGroup cols={2}>
  <Card title="Pulse Realtime quickstart" icon="microphone" href="/models/documentation/speech-to-text-pulse/realtime-web-socket/quickstart">
    Streaming STT setup.
  </Card>
  <Card title="Lightning Streaming" icon="bars-staggered" href="/models/documentation/text-to-speech-lightning/streaming">
    Streaming TTS setup.
  </Card>
  <Card title="Electron Tool Calling" icon="screwdriver-wrench" href="/models/documentation/llm-electron/tool-function-calling">
    Filler-phrase pattern in depth.
  </Card>
  <Card title="Atoms — managed voice agents" icon="phone" href="/voice-agents/platform/get-started/quick-start">
