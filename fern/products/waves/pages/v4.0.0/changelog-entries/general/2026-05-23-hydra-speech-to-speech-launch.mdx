...
- [Realtime Protocol](/waves/documentation/speech-to-speech-hydra/realtime-protocol) — full event reference, session config, tool calling, interruption, errors, browser + Python clients.
