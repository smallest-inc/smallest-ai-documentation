...
date: 2026-05-12
description: Lightning v3.1 (sync / SSE / WS) and Pulse (REST / WS) endpoint descriptions rewritten with copy-paste-runnable examples in cURL, Python (smallestai>=4.4.0), and JavaScript (fetch / ws). All samples live-tested against api.smallest.ai.
---
