...
**SDK impact:** the next SDK release will no longer expose the legacy streaming-STT methods generated from the old spec. Existing SDK releases keep working until upgrade. Migrate to Pulse STT — see the [Pulse STT WebSocket reference](/waves/api-reference/api-reference/speech-to-text/speech-to-text) and the [Pulse quickstart](/waves/documentation/speech-to-text-pulse/quickstart).
