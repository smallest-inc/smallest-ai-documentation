...
If your code still calls `wss://api.smallest.ai/waves/v1/lightning/get_text`, migrate to Pulse STT — the request shape is similar; see the [Pulse STT quickstart](/waves/documentation/speech-to-text-pulse/quickstart) and the [Pulse WebSocket reference](/waves/api-reference/api-reference/speech-to-text/speech-to-text).
