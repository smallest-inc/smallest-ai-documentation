...
→ [Word-level timestamps on the Lightning v3.1 model card](/models/model-cards/text-to-speech/lightning-v-3-1#word-level-timestamps) — full wire spec, JS example, support matrix.
