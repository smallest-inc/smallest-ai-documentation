...
| `pronunciation_dicts` | array | — | List of [pronunciation dictionary](/waves/documentation/text-to-speech/pronunciation-dictionaries) IDs |
...
For real-time streaming where audio starts playing before generation completes, see [Streaming TTS](/waves/documentation/text-to-speech/stream-tts).

## Need Help?

Check out the [API Reference](/waves/documentation/api-references/lightning-v3.1) for the full endpoint specification, or ask on [Discord](https://discord.gg/5evETqguJs).
