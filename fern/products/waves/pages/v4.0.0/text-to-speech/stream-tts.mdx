...
description: "Stream TTS audio in real-time via WebSocket or SSE — first chunk in ~200ms."
icon: "bars-staggered"
---

Streaming TTS delivers audio chunks as they're generated — playback starts immediately instead of waiting for the full file. First chunk arrives in ~200ms.
