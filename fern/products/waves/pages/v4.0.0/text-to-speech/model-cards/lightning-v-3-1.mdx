...
**Jump to:** [Benchmarks](#performance--benchmarks) · [Voice Catalog](#voice-catalog) · [Supported Languages](#supported-languages) · [API Reference](/waves/api-reference/api-reference/text-to-speech/synthesize-speech) · [Quickstart](/waves/documentation/text-to-speech-lightning/quickstart)
...
| **Documentation** | [docs.smallest.ai/models](https://docs.smallest.ai/waves/documentation/getting-started/models) |
