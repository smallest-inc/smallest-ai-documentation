...
Pro improves on standard Lightning v3.1 across accuracy and MOS quality. The table below reports Pro's scores; for cross-system comparisons against competitor TTS systems see the [Lightning v3.1 model card](/waves/model-cards/text-to-speech/lightning-v-3-1).
...
<Note>
For cross-system comparison against competitor TTS systems, see the [WV-MOS benchmarks](/waves/model-cards/text-to-speech/lightning-v-3-1#mos-v2) on the Lightning v3.1 model card.
</Note>
