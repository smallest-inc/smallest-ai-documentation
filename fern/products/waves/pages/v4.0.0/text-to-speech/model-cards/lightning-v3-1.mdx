...
Head-to-head listener evaluation against eight production TTS systems on the EmergentTTS benchmark, 1,088 samples scored by the LLM-as-a-Judge framework. The first table is the win-rate breakdown per competitor; the second is the per-metric score comparison across the full lineup.

### Win, tie, loss against each competitor

Direct head-to-head listener ratings. **Lightning Wins %** is the share where Lightning v3.1 was preferred. **Ties %** is the share where listeners scored both equally. **Competitor Wins %** is the inverse. Each column sums to 100%.

| EmergentTTS | Direction | GPT-4o-mini (OpenAI) | EL Turbo v2.5 (ElevenLabs) | EL Multi v2 (ElevenLabs) | Sonic-3 (Cartesia) | Gemini 2.5 Pro (Google) | MAi-Voice-1 (Microsoft) | Inworld 1.5 (Inworld) | s2-pro (Fish) |
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|
| Lightning Wins % | higher is better | 40.26% | 50.28% | 54.41% | 68.29% | 58.43% | 57.17% | 54.41% | 64.25% |
| Ties %           | n/a              | 24.17% | 25.00% | 23.81% | 17.00% |  8.29% | 17.00% | 18.11% | 13.60% |
| Competitor Wins %| lower is better  | 35.57% | 24.72% | 21.78% | 14.71% | 33.27% | 25.83% | 27.48% | 22.15% |

### Per-metric scores

Mean listener score per metric across the same 1,088-sample EmergentTTS test set. Definitions describe what the metric measures; Direction indicates whether higher or lower is better.

| Category | Metric | Definition | Direction | Lightning v3.1 | GPT-4o-mini (OpenAI) | EL Turbo v2.5 (ElevenLabs) | EL Multi v2 (ElevenLabs) | Sonic-3 (Cartesia) | Gemini 2.5 Pro (Google) | MAi-Voice-1 (Microsoft) | Inworld 1.5 (Inworld) | s2-pro (Fish) |
|---|---|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| Naturalness | Overall | Holistic listener rating of how natural the voice sounds end-to-end. | higher is better | 3.25 | 3.13 | 3.16 | 3.17 | 3.20 | 3.07 | 3.17 | 3.06 | 3.02 |
| Naturalness | Naturalness | How human-like the voice sounds; penalizes robotic or synthetic quality. | higher is better | 2.61 | 2.41 | 2.52 | 2.55 | 2.57 | 2.42 | 2.57 | 2.41 | 2.37 |
| Naturalness | Intonation | Whether pitch rises and falls appropriately for the sentence type (question, statement, exclamation). | higher is better | 3.22 | 3.06 | 3.07 | 3.06 | 3.12 | 2.90 | 3.04 | 2.91 | 2.86 |
| Naturalness | Prosody | The broader umbrella of rhythm, stress, and melody — how well the voice "reads" the sentence as a human would. | higher is better | 3.01 | 2.73 | 2.82 | 2.86 | 2.83 | 2.65 | 2.76 | 2.61 | 2.58 |
| Naturalness | Pronunciation\* | Whether individual words are phonetically correct, especially names, loanwords, and domain-specific terms. | higher is better | 3.63 | 3.67 | 3.64 | 3.65 | 3.67 | 3.67 | 3.68 | 3.68 | 3.57 |
| Naturalness | Audio Quality | Technical cleanliness of the output; absence of artifacts, distortion, clipping, or background noise. | higher is better | 3.76 | 3.78 | 3.77 | 3.75 | 3.81 | 3.73 | 3.79 | 3.70 | 3.75 |
| Expressiveness | Overall | Holistic listener rating of how expressive the voice sounds given the context of the sentence. | higher is better | 3.45 | 3.45 | 3.44 | 3.46 | 3.38 | 3.49 | 3.50 | 3.37 | 3.41 |
| Expressiveness | Paralinguistics | Non-verbal vocal elements like laughter, sighs, or filler sounds ("um", "uh") and whether they're rendered appropriately. | higher is better | 3.61 | 3.60 | 3.59 | 3.61 | 3.56 | 3.60 | 3.58 | 3.55 | 3.58 |
| Expressiveness | Emotions | How accurately the voice conveys the intended emotional tone (neutral, warm, urgent, etc.). | higher is better | 3.29 | 3.30 | 3.28 | 3.31 | 3.19 | 3.38 | 3.41 | 3.19 | 3.23 |
| Delivery | Boundary Consistency | Whether phrase and sentence boundaries are marked consistently with pauses or pitch shifts, without arbitrary breaks mid-phrase. | higher is better | 4.94 | 4.94 | 4.93 | 4.95 | 4.93 | 4.88 | 4.77 | 4.90 | 4.88 |
| Delivery | Pronunciation Style | Not just correctness, but stylistic choices: formal vs. casual register, regional accent consistency, honorific handling. | higher is better | 4.94 | 4.96 | 4.95 | 4.96 | 4.96 | 4.93 | 4.91 | 4.94 | 4.89 |
| Delivery | Natural Pace | Whether the speaking rate feels comfortable and appropriate for the content type, neither rushed nor dragging. | higher is better | 4.47 | 4.57 | 4.51 | 4.51 | 4.01 | 4.23 | 4.47 | 4.33 | 3.74 |
| Delivery | Pause Placement | Whether silences appear at semantically correct points (after commas, between clauses) rather than mid-word or mid-phrase. | higher is better | 4.46 | 4.54 | 4.49 | 4.51 | 4.28 | 4.34 | 4.41 | 4.38 | 4.09 |
| Delivery | Breathing Naturalness | Whether breath sounds occur at realistic points and with realistic frequency — not absent entirely or inserted randomly. | higher is better | 3.82 | 3.06 | 3.14 | 3.14 | 2.79 | 2.88 | 3.28 | 2.77 | 2.42 |
| Accuracy | WER\* | (Word Error Rate) — Percentage of words in the transcript that differ from the reference. Measures how faithfully the TTS renders the input text. | lower is better | 1.57% | 1.26% | 1.35% | 1.33% | 1.43% | 1.26% | 1.25% | 1.10% | 2.83% |
| Accuracy | CER | (Character Error Rate) — Like WER but at the character level. | lower is better | 0.67% | 0.52% | 0.60% | 0.54% | 0.59% | 0.62% | 0.50% | 0.47% | 1.16% |
| Accuracy | Hallucination | Words or sounds the TTS generates that have no basis in the input text. Insertions, substitutions, or fabricated content. | lower is better | 0.03% | 0.07% | 0.08% | 0.01% | 0.06% | 0.04% | 0.06% | 0.00% | 0.22% |
| Accuracy (Whisper jiwer) | Pronunciation % | The proportion of words pronounced correctly out of total words. | higher is better | 98.61% | 98.94% | 98.90% | 98.87% | 98.79% | 99.02% | 98.95% | 99.02% | 97.72% |
| MOS v2 | WV-MOS | The average of all listener ratings on a 1-5 scale across a test set; the standard aggregate quality metric in TTS evaluation. | higher is better | 4.71 | 4.55 | 4.60 | 4.63 | 4.76 | 4.65 | 4.62 | 4.91 | 4.48 |
