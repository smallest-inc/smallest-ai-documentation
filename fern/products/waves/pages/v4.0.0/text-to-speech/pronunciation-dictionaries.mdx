...
<CardGroup cols={3}>
  <Card title="API Reference" icon="code" href="/waves/documentation/api-references/pronunciations-dict/create">
    Explore detailed parameter information for pronunciation dictionary endpoints.
  </Card>
  <Card title="TTS Best Practices" icon="lightbulb" href="/waves/documentation/best-practices/tts-best-practices">
    Optimization tips for text formatting and audio generation.
  </Card>
  <Card title="Voice Cloning" icon="microphone" href="/waves/documentation/voice-cloning/how-to-vc">
