...
- Explore the [API Reference](/waves/api-reference/pronunciation-dictionaries/create-dictionary) for detailed parameter information
- Check out [TTS Best Practices](/waves/documentation/best-practices/tts-best-practices) for optimization tips
- Learn about [Voice Cloning](/waves/documentation/voice-cloning/how-to-voice-clone) to create custom voices
