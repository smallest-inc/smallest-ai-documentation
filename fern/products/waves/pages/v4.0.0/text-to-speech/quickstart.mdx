...
<CardGroup cols={2}>
  <Card title="Lightning v3.1 Pro" icon="sparkles" href="/models/model-cards/text-to-speech/lightning-v-3-1-pro">
    Premium voice catalog across American, British, and Indian accents, plus dedicated voices for 27 additional languages. Pass `model: lightning_v3.1_pro` to use.
  </Card>
