...
1. Visit the [platform](https://app.smallest.ai/dashboard/text-to-speech?utm_source=documentation&utm_medium=text-to-speech) and sign up for an account or log in if you already have an account.  
