...
**Jump to:** [Benchmarks](#performance--benchmarks) · [API Reference](/waves/api-reference/api-reference/speech-to-text/transcribe) · [Pricing & Throughput](#throughput-latency-and-pricing) · [Pre-recorded Quickstart](/waves/documentation/speech-to-text-pulse/pre-recorded/quickstart)

<CardGroup cols={4}>
  <Card title="5.42% WER" icon="bullseye" href="#performance--benchmarks">
    Open ASR Leaderboard average, English
  </Card>
  <Card title="250–300× RTFx" icon="gauge-high" href="#throughput-latency-and-pricing">
  ...
  <Card title="$0.004 / min" icon="tag" href="#throughput-latency-and-pricing">
...
<Capabilities bordered>
  ...
  <Capability icon="bolt" name="High Throughput" href="#throughput-latency-and-pricing">
