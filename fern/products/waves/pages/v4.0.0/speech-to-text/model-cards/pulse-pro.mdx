...
**Jump to:** [Benchmarks](#performance--benchmarks) · [API Reference](/waves/api-reference/api-reference/speech-to-text/transcribe) · [Pre-recorded Quickstart](/waves/documentation/speech-to-text-pulse/pre-recorded/quickstart)
