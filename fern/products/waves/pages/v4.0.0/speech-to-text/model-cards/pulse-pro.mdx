...
Pulse Pro is English-only. For multilingual transcription, use standard [Pulse](/waves/model-cards/speech-to-text/pulse) (21 streaming + 26 pre-recorded languages).
...
Pulse Pro v4.1 is trained exclusively on English. For multilingual transcription, use standard [Pulse](/waves/model-cards/speech-to-text/pulse) (21 streaming + 26 pre-recorded languages). Pulse Pro and Pulse share the same `/waves/v1/stt/` endpoint, so adding multilingual capability is a one-line `?model=` swap.
</Accordion>
