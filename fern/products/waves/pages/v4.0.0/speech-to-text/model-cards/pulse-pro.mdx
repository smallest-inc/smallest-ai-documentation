...
**Jump to:** [Benchmarks](#performance--benchmarks) · [API Reference](#api-reference) · [Pricing & Throughput](#throughput-latency--pricing) · [Pre-recorded Quickstart](/waves/documentation/speech-to-text-pulse/pre-recorded/quickstart)
