...
<CardGroup cols={4}>
  ...
  <Card title="31 Languages" icon="globe">
...
| 19 | Multi-Asian aggregator | `multi-asian` &mdash; auto-detects across `zh`, `yue`, `ko`, `ja`, `en`. US region only \[*]. Contact sales for access. |
