...
> **Temporary side-by-side compare — pick one and I'll remove the other.**
> Variant A below is borderless (current). Variant B is wrapped in a subtle outer container border. Both use the same `<Capabilities>` component.

### Variant A — Borderless (current)
...
### Variant B — Outer container border
