...
### Hindi — multi-dataset (Pre-recorded)

WER across seven Hindi datasets covering read speech, conversational speech, telephony / contact-center audio, and noise-augmented variants. Compared against IndicWhisper, Sarvam Saaras v3, Deepgram Nova-3, and our own previous Pulse generation. Lower is better.

| Dataset | IndicWhisper | Smallest Pulse | Pulse [Previous] | Sarvam Saaras v3 | Deepgram Nova-3 |
| ----- | :---: | :---: | :---: | :---: | :---: |
| **FLEURS** | 15.00 | 9.55 | 14.40 | **8.31** | 14.09 |
| **Kathbath** | 10.30 | 9.71 | 14.67 | **8.15** | 16.22 |
| **Kathbath (noisy)** | 12.00 | 10.94 | 16.09 | **10.81** | 17.06 |
| **Common Voice** | 11.40 | **11.20** | 20.81 | 11.36 | 23.55 |
| **Indic-TTS** | 7.60 | **6.39** | 10.47 | 6.49 | 10.72 |
| **MUCS** | 12.00 | 9.19 | 21.42 | **8.96** | 16.20 |
| **Gramvaani** | 26.80 | **21.43** | 29.25 | 21.80 | 31.44 |

The "Pulse [Previous]" column reflects generation-over-generation improvement — the current model lowers WER on every Hindi dataset versus the prior Pulse generation. For the full breakdown including training-data and evaluation-protocol notes, see the [Performance page](/waves/documentation/speech-to-text-pulse/benchmarks/performance#hindi-multi-dataset-pre-recorded).
