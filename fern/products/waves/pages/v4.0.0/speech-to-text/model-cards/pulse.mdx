...
| 16 | Oriya | `or` |
| 17 | Bengali | `bn` |
| 18 | Tamil | `ta` &mdash; India region only \[**] |
| 19 | Telugu | `te` &mdash; India region only \[**] |
| 20 | Kannada | `kn` &mdash; India region only \[**] |
| 21 | Malayalam | `ml` &mdash; India region only \[**] |
...
| 24 | South-Indic aggregator | `multi-south-indic` &mdash; auto-detects across `ta`, `te`, `kn`, `ml`, and English code-switching. India region only \[**]. Use when the South Indian language is not known in advance. |
