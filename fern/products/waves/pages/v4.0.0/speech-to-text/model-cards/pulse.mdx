...
<CardGroup cols={3}>
  ...
  <Card title="Console" icon="gauge" href="https://app.smallest.ai/dashboard">
    app.smallest.ai/dashboard
  </Card>
  <Card title="Documentation" icon="book" href="https://docs.smallest.ai/waves/v-4-0-0/documentation/speech-to-text-pulse/quickstart">
    docs.smallest.ai/waves
  </Card>
</CardGroup>
