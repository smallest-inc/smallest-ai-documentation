...
L4 is the recommended production GPU and runs at lower throughput than the L40S reference. See [Cloud deployment](/waves/on-premises-deployment/docker-setup/stt-deployment/cloud-deployment) for sizing.
...
| Dataset | Smallest Pulse | Assembly Universal Pro 3 | AWS Transcibe | Azure | Deepgram Nova 3 | Sarvam Saras V3 | ElevenLabs Scribe V2 |
| :--- | :---: | :---: | :---: | :---: | :---: | :---: | :---: |
