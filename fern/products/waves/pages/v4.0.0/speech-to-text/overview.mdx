...
<AccordionGroup>
  ...
  <Accordion title="Low Latency">
    Streaming pipeline tuned for real-time conversational AI and live captioning. See the [Pulse model card](/waves/model-cards/speech-to-text/pulse) for latency numbers.
  </Accordion>
</AccordionGroup>
