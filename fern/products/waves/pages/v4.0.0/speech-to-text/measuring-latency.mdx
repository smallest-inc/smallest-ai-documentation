...
| Workload | Use | Why |
|---|---|---|
| Voice agent (English or multilingual) | **Pulse** (`?model=pulse`) | ~150 ms streaming TTFT at 1 concurrency, full streaming WebSocket with `finalize` support, 17 streaming languages including English. |
