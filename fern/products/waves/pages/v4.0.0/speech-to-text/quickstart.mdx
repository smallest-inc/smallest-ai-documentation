...
<Note>
This quickstart uses **Pulse Pro**, our leaderboard-ranked English model. If you need multilingual transcription (17 streaming + 26 pre-recorded languages) or streaming, swap `?model=pulse-pro` for `?model=pulse`. See the [Pulse model card](/waves/model-cards/speech-to-text/pulse) for the full language list.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Language Detection" icon="globe" href="/waves/documentation/speech-to-text-pulse/features/language-detection">
    Auto-detect across regional language aggregators (`multi-eu`, `north_indic`, `multi-asian`).
  </Card>
