...
<Note>
These examples use a local `audio.wav` file. You can use any WAV file, or download our sample:

```bash
curl -L -o audio.wav "https://github.com/smallest-inc/cookbook/raw/main/speech-to-text/getting-started/samples/audio.wav"
```
</Note>
