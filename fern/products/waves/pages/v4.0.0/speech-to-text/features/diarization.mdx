...
Pass `diarize=true` when calling the Pulse STT POST endpoint. The parameter can be combined with other enrichment options (`word_timestamps`, `redact`, `utterances`) without changing your audio payload.
