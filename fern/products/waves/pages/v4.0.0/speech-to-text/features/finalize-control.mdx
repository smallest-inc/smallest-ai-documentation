...
- [Pulse STT WebSocket reference](/models/api-reference/speech-to-text/speech-to-text) — full parameter reference and the `finalize` / `close_stream` control messages.
