...
For detailed information about response fields, see the [response format documentation](/waves/documentation/speech-to-text-pulse/realtime/response-format).
...
- Learn about [supported audio formats](/waves/documentation/speech-to-text-pulse/realtime/audio-formats) for WebSocket streaming.
- Review complete [code examples](/waves/documentation/speech-to-text-pulse/realtime/code-examples) for Python, Node.js, and Browser JavaScript.
- Follow [best practices](/waves/documentation/speech-to-text-pulse/realtime/best-practices) for optimal streaming performance.
- Troubleshoot common issues in the [troubleshooting guide](/waves/documentation/speech-to-text-pulse/realtime/troubleshooting).
