...
<Note>
  For the full list of voices, sample rates, languages, and output formats, see the [Voices & Languages](/waves/documentation/text-to-speech-lightning/voices-languages) page.
</Note>
