...
200+ voices across 12 languages, split across the Standard and Pro pools. **Pair the voice with its pool** — Standard voices use `lightning_v3.1`, Pro voices require `lightning_v3.1_pro` (the API rejects a Pro voice on the standard model).
