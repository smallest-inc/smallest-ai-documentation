...
|---|---|
| `lightning_v3.1` | Default. 44.1 kHz, natural expressive speech, ~200 ms TTFB, 12 languages plus `auto` for code-switching, voice cloning supported. See the [Lightning v3.1 model card](/waves/model-cards/text-to-speech/lightning-v-3-1#supported-languages) for the full language list. |
| `lightning_v3.1_pro` | Premium broadcast-quality pool (English + Hindi). American / British / Indian accents; Indian voices code-switch automatically. No voice cloning. See the [Lightning v3.1 Pro model card](/waves/model-cards/text-to-speech/lightning-v-3-1-pro). |
