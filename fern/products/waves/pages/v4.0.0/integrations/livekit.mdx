...
- `"lightning_v3.1_pro"` is the default TTS model — a premium 44.1 kHz pool with curated American, British, and Indian voices. Use `"lightning_v3.1"` for the standard pool with 217 voices across 12 languages.
