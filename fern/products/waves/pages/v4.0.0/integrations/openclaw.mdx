...
- ~200 ms time-to-first-byte TTS via Lightning v3.1 (at 40 concurrent on the production benchmark)
- ~150 ms streaming TTFT speech-to-text via Pulse (at 1 concurrency, scaling to ~300 ms at 100)
