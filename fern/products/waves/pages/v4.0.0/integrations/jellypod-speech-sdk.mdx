...
|-------|------|-----------|--------|---------------|
| `lightning-v3.1` | Standard | 15 | 217 | Yes (5–15s of audio) |
...
smallestAI()                       // lightning-v3.1 (default)
smallestAI("lightning-v3.1")       // standard pool — 15 languages, 217 voices
