...
tts = SmallestTTSService(
    ...
    settings=SmallestTTSService.Settings(
        model=SmallestTTSModel.LIGHTNING_V3_1_PRO,  # default
        voice="meher",                               # default for lightning_v3.1_pro
    ),
)
```
...
| --------------- | -------- | ----------------------- | ------------------------------------------------------------------------------------ |
| `api_key`       | `str`    | —                       | Your Smallest AI API key (required)                                                  |
| `model`         | `str`    | `lightning_v3.1_pro`    | TTS model. One of `lightning_v3.1`, `lightning_v3.1_pro`                             |
| `voice`         | `str`    | model-dependent         | Voice ID. Defaults to `meher` for `lightning_v3.1_pro`, `sophia` for `lightning_v3.1` |
