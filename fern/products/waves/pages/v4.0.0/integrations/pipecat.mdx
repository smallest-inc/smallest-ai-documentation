---
title: "Pipecat"
description: "Build real-time voice AI pipelines using Smallest AI TTS with Pipecat."
icon: "microphone-lines"
---

This guide walks you through integrating [Smallest AI](https://smallest.ai) TTS into a [Pipecat](https://github.com/pipecat-ai/pipecat) voice pipeline. Pipecat is an open-source Python framework for building real-time voice and multimodal conversational AI agents using a frame-based architecture.

## Code Examples Repository

You can find the full example for this setup in the Pipecat repository:

[Pipecat Example — Smallest AI TTS](https://github.com/pipecat-ai/pipecat/blob/main/examples/foundational/07zl-interruptible-smallest.py)
...
- For any issues or questions, feel free to open an issue in the [Pipecat repository](https://github.com/pipecat-ai/pipecat) or contact us on [Discord](https://discord.gg/Ub25S48hSf).
