...
```
POST https://api.smallest.ai/waves/v1/stt/?model=pulse&language=en
...
Pulse supports 17 streaming + 26 pre-recorded languages including English, Hindi, Spanish, French, German, Bengali, Marathi, Gujarati, and more. See the [Pulse overview](/waves/documentation/speech-to-text-pulse/overview) for the full list.
...
<CardGroup cols={2}>
  ...
  <Card title="Pulse API Reference" icon="code" href="/waves/api-reference/api-reference/speech-to-text/transcribe">
