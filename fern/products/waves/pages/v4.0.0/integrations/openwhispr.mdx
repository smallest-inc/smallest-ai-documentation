...
Pulse supports 21 streaming + 26 pre-recorded languages including English, Hindi, Spanish, French, German, Bengali, Marathi, Gujarati, and more. See the [Pulse overview](/models/documentation/speech-to-text-pulse/overview) for the full list.
...
<CardGroup cols={2}>
  ...
  <Card title="Pulse API Reference" icon="code" href="/models/api-reference/api-reference/speech-to-text/transcribe">
