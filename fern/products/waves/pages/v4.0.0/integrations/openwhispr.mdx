...
Pulse supports 21 streaming + 26 pre-recorded languages including English, Hindi, Spanish, French, German, Bengali, Marathi, Gujarati, and more. See the [Pulse overview](/waves/documentation/speech-to-text-pulse/overview) for the full list.
