...
**Supported languages:** English, Hindi, Spanish, French, German, Bengali, Marathi, Gujarati, and more (21 streaming + 26 pre-recorded languages). See the [Pulse model card](/models/model-cards/speech-to-text/pulse) for the full list. Set `language` to a regional aggregator (`north_indic`, `multi-eu`, `multi-asian`) for automatic detection within a language family.
