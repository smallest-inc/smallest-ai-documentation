...
| -------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `lightning_v3.1`     | 12 — [model card](/waves/model-cards/text-to-speech/lightning-v-3-1)                  | Default. Supports [cloned voices](/waves/documentation/voice-cloning/instant-clone-api)  |
| `lightning_v3.1_pro` | 29 — [model card](/waves/model-cards/text-to-speech/lightning-v-3-1-pro)              | Premium voice pool. No cloning                                                           |
