...
<Note>
Ensure you've completed all [prerequisites](/v4.0.0/content/on-prem/docker/tts/prerequisites/hardware-requirements) before starting this guide.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="TTS Services Overview" icon="layer-group" href="/v4.0.0/content/on-prem/docker/tts/services-overview">
