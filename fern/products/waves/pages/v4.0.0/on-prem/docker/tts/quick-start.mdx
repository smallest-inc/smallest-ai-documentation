...
<CardGroup cols={2}>
  <Card title="TTS Configuration" icon="gear" href="/waves/self-host/docker-setup/tts-deployment/configuration">
    Customize your TTS deployment with advanced configuration options
  </Card>

  <Card title="TTS Services Overview" icon="layer-group" href="/waves/self-host/docker-setup/tts-deployment/quick-start">
    Learn about each TTS service component in detail
  </Card>

  <Card title="TTS Troubleshooting" icon="wrench" href="/waves/self-host/docker-setup/tts-deployment/troubleshooting">
