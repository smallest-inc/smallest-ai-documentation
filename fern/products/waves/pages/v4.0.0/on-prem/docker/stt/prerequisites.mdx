---
title: Prerequisites
description: System requirements and setup needed before deploying Speech-to-Text with Docker
---
...
<Card title="STT Quick Start" icon="rocket" href="/waves/self-host/docker-setup/stt-deployment/quick-start">
