...
<Note>
  Ensure you've completed all [prerequisites](/waves/self-host/docker-setup/stt-deployment/prerequisites) before
  starting this guide.
</Note>
...
<CardGroup cols={2}>
  <Card title="STT Configuration" icon="gear" href="/waves/self-host/docker-setup/stt-deployment/configuration">
    Customize your deployment with advanced configuration options
  </Card>

  <Card title="STT Services Overview" icon="layer-group" href="/waves/self-host/docker-setup/stt-deployment/quick-start">
    Learn about each service component in detail
  </Card>

  <Card title="STT Troubleshooting" icon="wrench" href="/waves/self-host/docker-setup/stt-deployment/troubleshooting">
    Debug common issues and optimize performance
  </Card>

  <Card title="API Reference" icon="code" href="/waves/api-reference/api-references/authentication">
