...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/waves/api-reference/api-references/authentication">
    Learn about API authentication
  </Card>

  <Card title="Troubleshooting" icon="wrench" href="/waves/self-host/troubleshooting/common-issues">
