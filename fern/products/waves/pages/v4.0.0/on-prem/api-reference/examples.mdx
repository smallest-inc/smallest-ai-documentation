...
<CardGroup cols={2}>
  <Card title="Authentication" icon="key" href="/v4.0.0/content/on-prem/api-reference/authentication">
    Learn about API authentication
  </Card>

  <Card title="Troubleshooting" icon="wrench" href="/v4.0.0/content/on-prem/troubleshooting/common-issues">
