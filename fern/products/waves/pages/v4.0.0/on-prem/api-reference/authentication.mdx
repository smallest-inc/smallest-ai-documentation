...
<CardGroup cols={2}>
  <Card title="Transcription Endpoint" icon="microphone" href="/waves/api-reference/speech-to-text/pulse-stt">
  ...
  <Card title="Examples" icon="code" href="/waves/documentation/text-to-speech/quickstart">
