...
<CardGroup cols={2}>
  ...
  <Card title="Metrics Setup" icon="chart-bar" href="/waves/self-host/kubernetes-setup/autoscaling/metrics-setup">
    Configure Prometheus and custom metrics
  </Card>

  <Card title="Grafana Dashboards" icon="chart-line" href="/waves/self-host/kubernetes-setup/autoscaling/grafana-dashboards">
