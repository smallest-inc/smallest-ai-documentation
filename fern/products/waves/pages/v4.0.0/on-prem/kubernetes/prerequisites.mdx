...
<Warning>
**Kubernetes deployment is currently only available for ASR (Speech-to-Text).** TTS (Text-to-Speech) Kubernetes support is coming soon. For TTS deployments, please use [Docker](/waves/self-host/docker-setup/tts-deployment/quick-start).
</Warning>
...
<Tip>
See the [AWS Deployment](/waves/self-host/kubernetes-setup/quick-start) guide for detailed setup instructions.
</Tip>
...
<Card title="AWS EKS Setup" icon="aws" href="/waves/self-host/kubernetes-setup/quick-start">
...
<Card title="Quick Start" icon="rocket" href="/waves/self-host/kubernetes-setup/quick-start">
