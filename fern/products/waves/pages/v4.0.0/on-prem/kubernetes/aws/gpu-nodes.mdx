...
<CardGroup cols={2}>
  ...
  <Card title="HPA Configuration" icon="chart-line" href="/waves/self-host/kubernetes-setup/autoscaling/hpa-configuration">
    Configure pod autoscaling based on metrics
  </Card>

  <Card title="Cluster Autoscaler" icon="arrows-up-down" href="/waves/self-host/kubernetes-setup/autoscaling/cluster-autoscaler">
