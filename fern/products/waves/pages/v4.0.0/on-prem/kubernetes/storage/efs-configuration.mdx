...
<Steps>
  <Step title="EFS CSI Driver">
    Install the EFS CSI driver (see [IAM & IRSA](/v4.0.0/content/on-prem/kubernetes/aws/iam-irsa) guide)
...
<CardGroup cols={2}>
  <Card title="Model Storage" icon="database" href="/v4.0.0/content/on-prem/kubernetes/storage/model-storage">
