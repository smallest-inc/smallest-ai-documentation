...
See [EFS Configuration](/v4.0.0/content/on-prem/kubernetes/storage/efs-configuration) for setup.
...
<CardGroup cols={2}>
  ...
  <Card title="Redis Persistence" icon="database" href="/v4.0.0/content/on-prem/kubernetes/storage/redis-persistence">
    Configure Redis data persistence
  </Card>

  <Card title="HPA Configuration" icon="chart-line" href="/v4.0.0/content/on-prem/kubernetes/autoscaling/hpa-configuration">
