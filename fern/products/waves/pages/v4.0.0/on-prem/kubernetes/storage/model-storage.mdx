...
See [EFS Configuration](/waves/self-host/kubernetes-setup/storage/efs-configuration) for setup.
...
<CardGroup cols={2}>
  ...
  <Card title="Redis Persistence" href="/waves/self-host/kubernetes-setup/storage/redis-persistence">
