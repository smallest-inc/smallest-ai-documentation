...
<CardGroup cols={2}>
  <Card title="Logs Analysis" icon="file-lines" href="/waves/self-host/troubleshooting/logs-analysis">
    Learn to interpret logs and errors
  </Card>

  <Card title="Common Issues" icon="circle-question" href="/waves/self-host/troubleshooting/common-issues">
