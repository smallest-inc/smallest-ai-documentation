...
<AccordionGroup>
  <Accordion title="Check GPU Utilization">
    ```bash
    nvidia-smi
  ...
  <Accordion title="Enable GPU Persistence Mode">
    ```bash
...
<CardGroup cols={2}>
  ...
  <Card title="Logs Analysis" href="/models/self-host/troubleshooting/logs-analysis">
