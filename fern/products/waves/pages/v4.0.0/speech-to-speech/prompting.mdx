...
The set of supported emotions is voice-dependent and evolving. The example above is the documented form; test against the voice you're using to confirm which emotion values render with the prosody you want.
