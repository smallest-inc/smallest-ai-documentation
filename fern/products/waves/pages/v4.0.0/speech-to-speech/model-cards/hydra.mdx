...
**Jump to:** [Benchmarks](#performance--benchmarks) · [Voices](#voices) · [API Reference](/models/api-reference/api-reference/speech-to-speech/speech-to-speech) · [Pricing & Throughput](#throughput-latency--pricing) · [Quickstart](/models/documentation/speech-to-speech-hydra/quickstart)
...
See [Hydra (Realtime / WebSocket)](/models/api-reference/api-reference/speech-to-speech/speech-to-speech) for the full event schema. The [documentation hub](/models/documentation/speech-to-speech-hydra/overview) covers the event catalog, session config, tool calling, interruption handling, and errors end-to-end.
