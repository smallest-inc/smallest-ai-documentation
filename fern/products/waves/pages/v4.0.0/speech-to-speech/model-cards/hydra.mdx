...
**Jump to:** [Benchmarks](#performance--benchmarks) · [Voices](#voices) · [API Reference](/waves/api-reference/api-reference/speech-to-speech/speech-to-speech) · [Pricing & Throughput](#throughput-latency--pricing) · [Quickstart](/waves/documentation/speech-to-speech-hydra/quickstart)
...
See [Hydra (Realtime / WebSocket)](/waves/api-reference/api-reference/speech-to-speech/speech-to-speech) for the full event schema. The [documentation hub](/waves/documentation/speech-to-speech-hydra/overview) covers the event catalog, session config, tool calling, interruption handling, and errors end-to-end.
...
- **For compliance transcripts, mirror the PCM through [Pulse STT](/waves/documentation/speech-to-text-pulse/overview)** after the session — Hydra itself does not emit transcripts on the wire.
