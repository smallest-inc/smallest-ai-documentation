...
- [Prompting voice agents](/waves/documentation/speech-to-speech-hydra/prompting-voice-agents) — phrasing `instructions` so the model reliably calls tools
- [Errors & reconnection](/waves/documentation/speech-to-speech-hydra/errors-reconnection) — `tool_response_timeout` and other failure modes
