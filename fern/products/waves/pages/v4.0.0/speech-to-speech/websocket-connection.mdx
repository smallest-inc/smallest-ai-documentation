...
<Tabs>
  ...
  <Tab title="Browser">
    ...
    ```
    The `WebSocket` global is supported in every modern browser. See the [browser client guide](/waves/documentation/speech-to-speech-hydra/quickstart#browser-client) for the full mic-and-playback wiring.
  </Tab>
</Tabs>
