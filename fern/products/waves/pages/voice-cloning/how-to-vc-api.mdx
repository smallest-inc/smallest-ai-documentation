...
|---|---|
| `lightning-v3.1` | `POST /waves/v1/tts` (with `model: lightning_v3.1`; cloning is not available on `lightning_v3.1_pro`) and the unified TTS streaming/WebSocket endpoints |
