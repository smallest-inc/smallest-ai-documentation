...
For recording guidelines, see [Voice Cloning Best Practices](/models/documentation/best-practices/voice-cloning-best-practices).
...
For best results, record reference audio in the same language as your intended output. See [Voice Cloning Best Practices](/models/documentation/best-practices/voice-cloning-best-practices) for multi-lingual cloning guidance.
...
For programmatic voice cloning (create clones via code), see [Voice Cloning via API](/models/documentation/voice-cloning/instant-clone-python-sdk).
