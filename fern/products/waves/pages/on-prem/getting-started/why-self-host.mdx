...
<CardGroup cols={2}>
  <Card title="Get Started" href="/self-host/getting-started/introduction">
    Return to the introduction for deployment options
  </Card>

  <Card title="Docker Quick Start" href="/self-host/docker-setup/stt-deployment/quick-start">
