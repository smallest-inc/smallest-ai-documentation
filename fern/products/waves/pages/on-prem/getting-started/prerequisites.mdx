...
<CardGroup cols={2}>
  <Card title="Docker Prerequisites" href="/self-host/docker-setup/stt-deployment/prerequisites/hardware-requirements">
    Setup requirements for Docker deployments including NVIDIA Container Toolkit installation.
  </Card>

  <Card title="Kubernetes Prerequisites" href="/self-host/kubernetes-setup/prerequisites/hardware-requirements">
