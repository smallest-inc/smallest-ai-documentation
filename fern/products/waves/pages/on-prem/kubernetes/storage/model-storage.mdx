...
See [EFS Configuration](/self-host/kubernetes-setup/storage-pvc/efs-configuration) for setup.
...
<CardGroup cols={2}>
  ...
  <Card title="Redis Persistence" href="/self-host/kubernetes-setup/storage-pvc/redis-persistence">
    Configure Redis data persistence
  </Card>

  <Card title="HPA Configuration" href="/self-host/kubernetes-setup/autoscaling/hpa-configuration">
