...
<Warning>
Kubernetes deployment is currently available for **ASR (Speech-to-Text)** only. For TTS deployments, use [Docker](/self-host/docker-setup/tts-deployment/quick-start).
</Warning>

<Note>
Ensure you've completed all [prerequisites](/self-host/kubernetes-setup/prerequisites/hardware-requirements) before starting.
</Note>
...
For detailed troubleshooting, see [Troubleshooting Guide](/self-host/kubernetes-setup/troubleshooting).

## Next Steps

<CardGroup cols={2}>
  <Card title="AWS Setup" href="/self-host/kubernetes-setup/aws/eks-setup">
    EKS-specific configuration
  </Card>

  <Card title="Model Storage" href="/self-host/kubernetes-setup/storage-pvc/model-storage">
    Shared storage for faster cold starts
  </Card>

  <Card title="Advanced Autoscaling" href="/self-host/kubernetes-setup/autoscaling/hpa-configuration">
    Fine-tune scaling behavior and thresholds
  </Card>

  <Card title="Monitoring" href="/self-host/kubernetes-setup/autoscaling/grafana-dashboards">
