...
<Steps>
  <Step title="IAM Role">
    Create IAM role with autoscaling permissions (see [IAM & IRSA](/self-host/kubernetes-setup/aws/iam-irsa))
  </Step>
...
See [Grafana Dashboards](/self-host/kubernetes-setup/autoscaling/grafana-dashboards)
...
Update IAM policy if needed (see [IAM & IRSA](/self-host/kubernetes-setup/aws/iam-irsa))
...
<CardGroup cols={2}>
  ...
  <Card title="Metrics Setup" href="/self-host/kubernetes-setup/autoscaling/metrics-setup">
    Set up Prometheus metrics
  </Card>

  <Card title="Grafana Dashboards" href="/self-host/kubernetes-setup/autoscaling/grafana-dashboards">
