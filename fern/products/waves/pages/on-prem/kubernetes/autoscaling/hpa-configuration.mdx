...
<Tip>
For complete cost savings during off-hours, use [Cluster Autoscaler](/models/self-host/kubernetes-setup/autoscaling/cluster-autoscaler) to scale nodes to zero.
</Tip>
...
<AccordionGroup>
  <Accordion title="Set Appropriate Targets">
  ...
  <Accordion title="Use Conservative Scale-Down">
  ...
  <Accordion title="Monitor HPA Decisions">
