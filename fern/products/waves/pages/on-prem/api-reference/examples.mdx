...
<AccordionGroup>
  ...
  <Accordion title="Add Retry Logic">
...
<CardGroup cols={2}>
  <Card title="Authentication" href="/models/self-host/api-reference/authentication">
    Learn about API authentication
  </Card>

  <Card title="Troubleshooting" href="/models/self-host/troubleshooting/common-issues">
