...
See [Authentication](/self-host/api-reference/authentication) for details.
...
<CardGroup cols={2}>
  <Card title="Health Check" href="/self-host/api-reference/endpoints/health-check">
    Monitor service availability
  </Card>

  <Card title="Examples" href="/self-host/api-reference/examples">
