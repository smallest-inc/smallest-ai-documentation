...
services:
  ...
  asr:
    ...
    environment:
      ...
      - MODEL_URL=https://d3f6tzcf3w0hyu.cloudfront.net/asr/pulse_batch_multi_eu_dr_pccpi_140326.smlst
...
- [Quick start](/models/self-host/docker-setup/stt-deployment/quick-start) - minimum single-deployment setup
- [Configuration reference](/models/self-host/docker-setup/stt-deployment/configuration) - all environment variables documented
- [Troubleshooting](/models/self-host/docker-setup/stt-deployment/troubleshooting) - common deploy issues
