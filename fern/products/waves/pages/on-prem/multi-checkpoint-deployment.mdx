...
- [Quick start](/self-host/docker-setup/stt-deployment/quick-start) - minimum single-deployment setup
- [Configuration reference](/self-host/docker-setup/stt-deployment/configuration) - all environment variables documented
- [Troubleshooting](/self-host/docker-setup/stt-deployment/troubleshooting) - common deploy issues
