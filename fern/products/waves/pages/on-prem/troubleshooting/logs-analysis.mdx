...
<CardGroup cols={2}>
  <Card title="Common Issues" href="/models/self-host/troubleshooting/common-issues">
    Quick solutions to frequent problems
  </Card>

  <Card title="Debugging Guide" href="/models/self-host/troubleshooting/debugging-guide">
