...
<Note>
Ensure you've completed all [prerequisites](/self-host/docker-setup/tts-deployment/prerequisites/hardware-requirements) before starting this guide.
</Note>
...
<CardGroup cols={2}>
  <Card title="TTS Configuration" href="/self-host/docker-setup/tts-deployment/configuration">
    Customize your TTS deployment with advanced configuration options
  </Card>

  <Card title="TTS Services Overview" href="/self-host/docker-setup/tts-deployment/services-overview">
    Learn about each TTS service component in detail
  </Card>

  <Card title="TTS Troubleshooting" href="/self-host/docker-setup/tts-deployment/troubleshooting">
