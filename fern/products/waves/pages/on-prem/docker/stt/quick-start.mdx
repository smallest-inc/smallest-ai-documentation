...
<Note>
  Ensure you've completed all [prerequisites](/self-host/docker-setup/stt-deployment/prerequisites/hardware-requirements) before
  starting this guide.
</Note>
...
<CardGroup cols={2}>
  <Card title="STT Configuration" href="/self-host/docker-setup/stt-deployment/configuration">
    Customize your deployment with advanced configuration options
  </Card>

  <Card title="STT Services Overview" href="/self-host/docker-setup/stt-deployment/services-overview">
    Learn about each service component in detail
  </Card>

  <Card title="STT Troubleshooting" href="/self-host/docker-setup/stt-deployment/troubleshooting">
    Debug common issues and optimize performance
  </Card>

  <Card title="API Reference" href="/self-host/api-reference/authentication">
