...
- [Hardware requirements](/self-host/docker-setup/stt-deployment/prerequisites/hardware-requirements) for picking a GPU.
- [Cloud deployment recommendations](/self-host/docker-setup/stt-deployment/cloud-deployment) for AWS, GCP, and Azure.
- [Quick Start](/self-host/docker-setup/stt-deployment/quick-start) to bring up a self-hosted STT cluster.
