...
<Tip>
If you want a full voice-agent platform with built-in telephony, campaigns, knowledge base, and call analytics, see [**Atoms**](/voice-agents/quickstart) - it's built on top of this exact stack. Use this cookbook when you want to build the pipeline yourself.
</Tip>
...
<CardGroup cols={2}>
  <Card title="Pulse Realtime quickstart" icon="microphone" href="/models/speech-to-text/realtime-web-socket/quickstart">
    Streaming STT setup.
  </Card>
  <Card title="Lightning Streaming" icon="bars-staggered" href="/models/text-to-speech/streaming">
    Streaming TTS setup.
  </Card>
  <Card title="Electron Tool Calling" icon="screwdriver-wrench" href="/models/llm/tool-function-calling">
    Filler-phrase pattern in depth.
  </Card>
  <Card title="Atoms - managed voice agents" icon="phone" href="/voice-agents/quickstart">
