...
Pulse supports 21 streaming + 26 pre-recorded languages including English, Hindi, Spanish, French, German, Bengali, Marathi, Gujarati, and more. See the [Pulse overview](/models/speech-to-text/overview) for the full list.
...
<CardGroup cols={2}>
  ...
  <Card title="Pulse STT Overview" icon="microphone" href="/models/speech-to-text/overview">
    Supported languages, features, and limits
  </Card>

  <Card title="Pulse API Reference" icon="code" href="/api-reference/models/speech-to-text/transcribe">
