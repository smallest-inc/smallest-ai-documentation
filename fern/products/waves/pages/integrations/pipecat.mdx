...
| `full_transcript`      | `bool`     | `False`       | Include cumulative transcript                                                                                                                                       |
| `sentence_timestamps`  | `bool`     | `False`       | Include sentence-level timestamps                                                                                                                                   |
| `redact_pii`           | `bool`     | `False`       | Redact personally identifiable information                                                                                                                          |
| `redact_pci`           | `bool`     | `False`       | Redact payment card information                                                                                                                                     |
| `numerals`             | `str`      | `"auto"`      | Convert spoken numerals to digits                                                                                                                                   |
| `diarize`              | `bool`     | `False`       | Enable speaker diarization                                                                                                                                          |
| `endpointing`          | `bool`     | `True`        | Finalize transcripts promptly on trailing silence                                                                                                                   |
| `keywords`             | `str`      | `""`          | Comma-separated `KEYWORD:INTENSIFIER` pairs to boost recognition of domain-specific words/phrases (e.g. `"NVIDIA:2"`)                                               |
| `format`               | `bool`     | `True`        | Apply punctuation and capitalization to transcripts                                                                                                                 |
