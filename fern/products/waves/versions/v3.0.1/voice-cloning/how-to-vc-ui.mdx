...
# Creating an Instant Voice Clone  
 ...
 1️. **Go to the Smallest AI Platform**  
   - Navigate to **[smallest.ai](https://api.smallest.ai/voice-clone)** and click on **Create New**.  
 ...
 2️. **Upload Your Clean Reference Audio**  
   ...
   - Follow the recommended **[best practices](/waves/v-3-0-1/guides/best-practices/vc-best-practices)** to maximize quality.  
