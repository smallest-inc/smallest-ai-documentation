...
<Update label="December 2024">
    ...
    Experience the new capabilities of Lightning Large via our [Platform](https://api.smallest.ai) or the [API](/waves/v-3-0-1/api-reference/text-to-speech/lightning-v-31).
</Update>
...
<Update label="November 2024">
    ...
    The voices available on waves platform are available via the [Waves API](/waves/v-3-0-1/api-reference/text-to-speech/lightning-v-31)
</Update> 
...
<Update label="October 2024">
    ...
    You can access lightning via the [Waves API](/waves/v-3-0-1/api-reference/text-to-speech/lightning-v-31)
</Update>
