---
title: 'Quickstart'
description: 'Get started with real-time transcription using the Lightning STT WebSocket API'
---
...
Head over to the [smallest console](https://app.smallest.ai/dashboard/settings) to generate an API key if not done previously. Also look at [Authentication guide](/waves/guides/getting-started/authentication) for more information about API keys and their usage.
...
For detailed information about response fields, see the [response format documentation](/waves/guides/speech-to-text/real-time/response-format).
...
- Learn about [supported audio formats](/waves/guides/speech-to-text/real-time/audio-formats) for WebSocket streaming.
- Review complete [code examples](/waves/guides/speech-to-text/real-time/code-examples) for Python, Node.js, and Browser JavaScript.
- Follow [best practices](/waves/guides/speech-to-text/real-time/best-practices) for optimal streaming performance.
- Troubleshoot common issues in the [troubleshooting guide](/waves/guides/speech-to-text/real-time/troubleshooting).
