...
| --- | --- | --- | --- |
| `api_key` | `str` | `$SMALLEST_API_KEY` | Your Smallest AI API key |
| `model` | `str` | `"lightning-v3.1"` | TTS model. Use `"lightning-v3.1"` — the current model with 217 voices and ~100ms latency |
...
- `"lightning-v3.1"` is the current TTS model — it delivers ~100ms latency with 217 voices across 12 languages.
