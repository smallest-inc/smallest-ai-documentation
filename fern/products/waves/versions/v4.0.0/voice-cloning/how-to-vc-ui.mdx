...
icon: "compact-disc"
description: 'Create an Instant Voice Clone in the Smallest AI dashboard with a short audio sample — no code required.'
---
...
# Creating an Instant Voice Clone  
 ...
 1️. **Go to the Smallest AI Platform**  
   - Navigate to the **[platform](https://app.smallest.ai/dashboard/voice-cloning?utm_source=documentation&utm_medium=voice-cloning)** and click on **Create New**.  
 ...
 2️. **Upload Your Clean Reference Audio**  
   ...
   - Follow the recommended **[best practices](/waves/v-4-0-0/documentation/best-practices/voice-cloning-best-practices)** to maximize quality.  
