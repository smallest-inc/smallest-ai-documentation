...
<CardGroup cols={1}>
  <Card title="Lightning v3.1" icon="sparkles" href="/waves/model-cards/text-to-speech/lightning-v-3-1">
    <Badge color="green">Latest Release</Badge> A 44 kHz model delivering natural, expressive, and realistic speech. Supports voice cloning with ultra-low latency. 22 languages plus `auto`-detect with mid-sentence code-switching.
  </Card>
</CardGroup>
...
| ------------------- | -------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [**lightning-v3.1**](/waves/model-cards/text-to-speech/lightning-v-3-1) <Badge color="green">Latest</Badge> | 44 kHz model, natural expressive speech, ultra-low latency, supports voice cloning. | `English` <br/> `Hindi` <br/> `Marathi` <br/> `Kannada` <br/> `Tamil` <br/> `Bengali` <br/> `Gujarati` <br/> `Telugu` <br/> `Malayalam` <br/> `Punjabi` <br/> `Odia` <br/> `Spanish` <br/> `German` <br/> `French` <br/> `Italian` <br/> `Polish` <br/> `Dutch` <br/> `Russian` <br/> `Swedish` <br/> `Portuguese` <br/> `Arabic` <br/> `Hebrew` <br/> `auto` |
