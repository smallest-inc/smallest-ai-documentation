---
title: "Introduction"
description: "Speech AI APIs by Smallest AI — generate speech with Lightning TTS, transcribe audio with Pulse STT, and reason with Electron LLM (OpenAI-compatible chat completions)."
icon: "book-open"
---
...
<CardGroup cols={2}>
  ...
  <Card title="Electron (LLM)" icon="wand-magic-sparkles" href="/waves/documentation/llm-electron/quickstart">
  ...
  <Card title="Hydra (Speech-to-Speech)" icon="wave-pulse" href="/waves/documentation/speech-to-speech-hydra/quickstart">
    Full-duplex voice over a single WebSocket. Audio in, audio out — no STT → LLM → TTS pipeline. Phone-grade latency with built-in barge-in handling.
  </Card>
</CardGroup>
...
<Steps>
  ...
  <Step title="Navigate to API Keys">
    Open the [API Keys page](https://app.smallest.ai/dashboard/api-keys) in the Smallest AI console.
