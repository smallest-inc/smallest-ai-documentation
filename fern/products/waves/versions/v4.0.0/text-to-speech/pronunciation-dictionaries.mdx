...
- Explore the [API Reference](/waves/api-reference/api-reference/create-pronunciation-dict) for detailed parameter information
- Check out [TTS Best Practices](/waves/guides/best-practices/tts-best-practices) for optimization tips
- Learn about [Voice Cloning](/waves/guides/voice-cloning/how-to-voice-clone) to create custom voices
