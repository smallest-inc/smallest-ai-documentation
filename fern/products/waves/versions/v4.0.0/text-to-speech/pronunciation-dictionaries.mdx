...
- Explore the [API Reference](/waves/api-reference/api-reference/text-to-speech/create-pronunciation-dict) for detailed parameter information
- Check out [TTS Best Practices](/waves/documentation/best-practices/tts-best-practices) for optimization tips
- Learn about [Voice Cloning](/waves/documentation/voice-cloning/how-to-vc) to create custom voices
