...
icon: "speaker"
description: "Learn how to create and use pronunciation dictionaries to control how specific words are pronounced in your text-to-speech synthesis"
---
...
- Explore the [API Reference](/waves/documentation/api-references/pronunciations-dict/create) for detailed parameter information
- Check out [TTS Best Practices](/waves/documentation/best-practices/tts-best-practices) for optimization tips
- Learn about [Voice Cloning](/waves/documentation/voice-cloning/instant-clone-python-sdk) to create custom voices
