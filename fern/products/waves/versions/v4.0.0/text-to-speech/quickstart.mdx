...
<CardGroup cols={2}>
  ...
  <Card title="Voices & Languages" icon="users" href="/waves/documentation/text-to-speech-lightning/features/voices-languages">
...
| `language` | string | `en` | `en`, `hi`, `es`, `ta`, or `auto` (per voice; see voice tags via `GET /waves/v1/lightning-v3.1/get_voices`) |
