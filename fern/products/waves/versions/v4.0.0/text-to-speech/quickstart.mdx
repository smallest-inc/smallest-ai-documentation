...
1. Visit the [platform](https://app.smallest.ai/dashboard/settings/apikeys?utm_source=documentation&utm_medium=text-to-speech) and sign up for an account or log in if you already have an account.  
2. Navigate to `API Key` tab in your account dashboard (Manage Plan section).
