...
<CardGroup cols={2}>
  <Card title="General Troubleshooting" href="/models/self-host/troubleshooting/common-issues">
    Platform-agnostic troubleshooting guide
  </Card>

  <Card title="API Reference" href="/models/api-reference/api-references/authentication">
