...
<CardGroup cols={2}>
  <Card title="HPA Configuration" icon="chart-line" href="/waves/guides/on-premise/kubernetes/autoscaling/hpa-configuration">
    Use metrics for autoscaling
  </Card>

  <Card title="Metrics Setup" icon="chart-bar" href="/waves/guides/on-premise/kubernetes/autoscaling/metrics-setup">
    Configure Prometheus metrics
  </Card>

  <Card title="License Proxy" icon="key" href="/waves/guides/on-premise/waves/self-host/kubernetes-setup/quick-start">
