...
<AccordionGroup>
  <Accordion title="Use Dashboard Folders">
  ...
  <Accordion title="Set Appropriate Time Ranges">
  ...
  <Accordion title="Use Annotations">
  ...
  <Accordion title="Template Dashboards">
  ...
  <Accordion title="Export and Version Control">
