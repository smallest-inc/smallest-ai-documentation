...
<Steps>
  <Step title="IAM Role">
    Create IAM role with autoscaling permissions (see [IAM & IRSA](/models/self-host/kubernetes-setup/aws/iam-irsa))
  </Step>
...
See [Grafana Dashboards](/models/self-host/kubernetes-setup/autoscaling/grafana-dashboards)
...
Update IAM policy if needed (see [IAM & IRSA](/models/self-host/kubernetes-setup/aws/iam-irsa))

## Best Practices

<AccordionGroup>
  <Accordion title="Tag Node Groups Properly">
  ...
  <Accordion title="Use PodDisruptionBudgets">
  ...
  <Accordion title="Monitor Scaling Events">
...
<CardGroup cols={2}>
  ...
  <Card title="Metrics Setup" href="/models/self-host/kubernetes-setup/autoscaling/metrics-setup">
    Set up Prometheus metrics
  </Card>

  <Card title="Grafana Dashboards" href="/models/self-host/kubernetes-setup/autoscaling/grafana-dashboards">
