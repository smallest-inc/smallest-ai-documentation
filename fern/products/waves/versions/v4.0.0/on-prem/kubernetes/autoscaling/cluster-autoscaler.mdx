...
<Steps>
  <Step title="IAM Role">
    Create IAM role with autoscaling permissions (see [IAM & IRSA](/v4.0.0/content/on-prem/kubernetes/aws/iam-irsa))
  </Step>
...
Update IAM policy if needed (see [IAM & IRSA](/v4.0.0/content/on-prem/kubernetes/aws/iam-irsa))
