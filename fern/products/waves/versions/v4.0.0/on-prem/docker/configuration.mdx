---
title: Configuration
description: Advanced configuration options for Docker deployments
---
...
<ParamField path="PORT" type="integer" default="7100">
...
<ParamField path="PORT" type="integer" default="3369">
...
<CardGroup cols={2}>
  ...
  <Card title="Troubleshooting" icon="wrench" href="/v4.0.0/content/on-prem/docker/docker-troubleshooting">
