...
<Note>
  Ensure you've completed all [prerequisites](/v4.0.0/content/on-prem/docker/stt/prerequisites/hardware-requirements) before
  starting this guide.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="STT Services Overview" icon="layer-group" href="/v4.0.0/content/on-prem/docker/stt/services-overview">
  ...
  <Card title="API Reference" icon="code" href="/v4.0.0/content/on-prem/api-reference/authentication">
