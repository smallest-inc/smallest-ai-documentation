...
See [Authentication](/models/self-host/api-reference/authentication) for details.
...
<table style={{ borderCollapse: 'separate', borderSpacing: 0, width: '100%', borderRadius: '8px', overflow: 'hidden' }}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)' }}>Widely supported</td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)' }}>Open format</td>
    </tr>
    <tr>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)', borderBottomLeftRadius: '8px' }}>M4A</td>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)' }}><code>.m4a</code></td>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)', borderBottomRightRadius: '8px' }}>Apple format</td>
    </tr>
  </tbody>
</table>
...
<table style={{ borderCollapse: 'separate', borderSpacing: 0, width: '100%', borderRadius: '8px', overflow: 'hidden' }}>
  ...
  <tbody>
    ...
    <tr>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)' }}>Latency (1 min audio)</td>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)' }}>3-9 seconds</td>
    </tr>
    <tr>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)' }}>Concurrent capacity</td>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)' }}>100+ requests</td>
    </tr>
    <tr>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)', borderBottomLeftRadius: '8px' }}>Throughput</td>
      <td style={{ padding: '12px 16px', border: '0.5px solid rgba(209, 213, 219, 0.2)', borderBottomRightRadius: '8px' }}>100+ hours/hour</td>
    </tr>
  </tbody>
</table>
...
<AccordionGroup>
  <Accordion title="Optimize Audio Quality">
  ...
  <Accordion title="Use Async for Long Audio">
...
<CardGroup cols={2}>
  <Card title="Health Check" href="/models/self-host/api-reference/endpoints/health-check">
    Monitor service availability
  </Card>

  <Card title="Examples" href="/models/self-host/api-reference/examples">
