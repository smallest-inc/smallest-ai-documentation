...
<CardGroup cols={2}>
  <Card title="Authentication" href="/waves/self-host/api-reference/authentication">
    Learn about API authentication
  </Card>

  <Card title="Troubleshooting" href="/waves/self-host/troubleshooting/common-issues">
