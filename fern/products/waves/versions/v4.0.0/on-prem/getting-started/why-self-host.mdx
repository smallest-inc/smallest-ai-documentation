...
<CardGroup cols={2}>
  <Card title="Get Started" href="/models/self-host/getting-started/introduction">
    Return to the introduction for deployment options
  </Card>

  <Card title="Docker Quick Start" href="/models/self-host/docker-setup/stt-deployment/quick-start">
