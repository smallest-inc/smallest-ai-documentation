...
<CardGroup cols={2}>
  <Card title="Docker STT" icon="server" href="/models/self-host/docker-setup/stt-deployment/quick-start">
    Deploy speech-to-text with Docker. Best for development, testing, and small-scale production.
  </Card>
  <Card title="Docker TTS" icon="server" href="/models/self-host/docker-setup/tts-deployment/quick-start">
    Deploy text-to-speech with Docker. Quick setup for voice synthesis workloads.
  </Card>
  <Card title="Kubernetes STT" icon="dharmachakra" href="/models/self-host/kubernetes-setup/quick-start">
...
<CardGroup cols={3}>
  <Card title="Architecture" icon="sitemap" href="/models/self-host/getting-started/architecture">
    System components and data flow
  </Card>
  <Card title="Why Self-Host?" icon="server" href="/models/self-host/getting-started/why-self-host">
    Benefits of self-hosting
  </Card>
  <Card title="Prerequisites" icon="list-check" href="/models/self-host/getting-started/prerequisites">
