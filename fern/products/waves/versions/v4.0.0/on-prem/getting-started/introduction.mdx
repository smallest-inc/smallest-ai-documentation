...
<CardGroup cols={2}>
  <Card title="Docker STT" href="/waves/self-host/docker-setup/stt-deployment/quick-start">
    Deploy speech-to-text with Docker. Best for development, testing, and small-scale production.
  </Card>
  <Card title="Docker TTS" href="/waves/self-host/docker-setup/tts-deployment/quick-start">
    Deploy text-to-speech with Docker. Quick setup for voice synthesis workloads.
  </Card>
  <Card title="Kubernetes STT" href="/waves/self-host/kubernetes-setup/quick-start">
...
<CardGroup cols={3}>
  <Card title="Architecture" href="/waves/self-host/getting-started/architecture">
