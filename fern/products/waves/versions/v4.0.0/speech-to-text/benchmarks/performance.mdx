...
WER across seven Hindi speech datasets covering read speech (FLEURS), conversational speech (Kathbath, Common Voice), telephony / contact-center audio (Mucs, Gramvaani), TTS-derived audio (Indic-TTS), and a noise-augmented variant (Kathbath noisy). Compared against the strongest Hindi STT baselines: IndicWhisper, scribe v2, and Deepgram Nova-3.

*Evaluated on the open-source datasets. Smallest Pulse numbers from internal evaluation. Lower is better.*

| Dataset | Smallest Pulse | IndicWhisper | scribe v2 | Deepgram Nova-3 |
| ----- | :---: | :---: | :---: | :---: |
| **FLEURS** | 10.02 | 15.00 | 8.96 | 14.09 |
| **Kathbath** | 9.20 | 10.30 | 8.67 | 16.22 |
| **Kathbath (noisy)** | 10.27 | 12.00 | 10.11 | 17.06 |
| **Common Voice** | **11.28** | 11.40 | 13.61 | 23.55 |
| **Indic-TTS** | **6.98** | 7.60 | 8.75 | 10.72 |
| **MUCS** | **7.05** | 12.00 | 8.15 | 16.20 |
| **Gramvaani** | **20.08** | 26.80 | 24.09 | 31.44 |
| **AVERAGE (unweighted)** | **10.70** | 13.59 | 11.76 | 18.47 |
| **OVERALL (refword-wtd)** | **10.84** | 13.07 | 10.97 | 18.80 |
