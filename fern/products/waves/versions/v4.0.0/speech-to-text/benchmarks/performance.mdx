...
The "Pulse [Previous]" column shows generation-over-generation improvement — the current Pulse model is lower-WER than the previous on every Hindi dataset (largest gain: MUCS, 21.42 → 9.19).
