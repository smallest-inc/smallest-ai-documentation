...
- For proper-noun mistakes, queue them for a [pronunciation dictionary](/waves/documentation/text-to-speech-lightning/features/pronunciation-dictionaries) if you also use Lightning TTS, or for the Pulse [keyword boosting](/waves/documentation/speech-to-text-pulse/features/keyword-boosting) feature on the streaming endpoint.
