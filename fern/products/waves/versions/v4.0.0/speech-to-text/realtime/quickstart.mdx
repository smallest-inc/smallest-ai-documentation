...
This guide shows you how to transcribe streaming audio using Smallest AI's Pulse STT model via the WebSocket API. Low-latency streaming, suitable for live conversations and voice assistants. See the [Pulse model card](/waves/model-cards/speech-to-text/pulse) for latency numbers.
