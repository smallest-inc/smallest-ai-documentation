...
Head over to the [smallest console](https://app.smallest.ai/dashboard/settings/apikeys?utm_source=documentation&utm_medium=speech-to-text) to generate an API key if not done previously. Also look at [Authentication guide](/v4.0.0/content/getting-started/authentication) for more information about API keys and their usage.
