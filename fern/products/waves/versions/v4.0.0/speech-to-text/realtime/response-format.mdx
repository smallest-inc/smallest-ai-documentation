...
<Note>
The `full_transcript` field is a feature that requires the `full_transcript` query parameter to be set to `true`. Learn more about the [Full Transcript feature](/waves/documentation/speech-to-text/features/full-transcript).
</Note>
