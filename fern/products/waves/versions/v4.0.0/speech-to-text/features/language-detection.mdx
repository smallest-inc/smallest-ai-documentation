...
description: 'Automatically detect and transcribe across the European, North Indian, South Indian, or East Asian Pulse STT language sets'
---
...
| `multi-south-indic` <Badge color="yellow">Beta</Badge> | — | ✅ (India region only) | `ta`, `te`, `kn`, `ml`, `en` (code-switching) |
