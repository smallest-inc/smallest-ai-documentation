...
<Note>
For new integrations we recommend [Inverse Text Normalization (`itn_normalize=true`)](/waves/documentation/speech-to-text-pulse/features/inverse-text-normalization) instead of `numerals`. ITN handles digits as well as dates, currencies, phone numbers, and other spoken-form entities, and gives more consistent results across languages.
</Note>
