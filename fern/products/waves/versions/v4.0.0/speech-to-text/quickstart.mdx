...
<Note>
For Pulse Pro, `language` must be `en`. For Pulse, set `language` to the known code (`en`, `hi`, `es`, etc.) for best accuracy, or use a regional aggregator (`multi-eu`, `multi-indic`) for unknown audio.
</Note>
