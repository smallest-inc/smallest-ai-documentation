...
<Note>
This quickstart uses **Pulse Pro**, our leaderboard-ranked English model. If you need multilingual transcription (21 streaming + 26 pre-recorded languages) or streaming, swap `?model=pulse-pro` for `?model=pulse`. See the [Pulse model card](/waves/model-cards/speech-to-text/pulse) for the full language list.
</Note>
