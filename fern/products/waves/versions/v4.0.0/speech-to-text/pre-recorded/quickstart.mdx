...
Head over to the [smallest console](https://app.smallest.ai/dashboard/api-keys) to generate an API key, if not done previously. Also look at the [Authentication guide](/models/api-reference/api-references/authentication) for more information about API keys.
