...
Use these codes on `WS /waves/v1/stt/live?model=pulse`. For unknown audio, pick a `multi-*` aggregator (see the [model card](/waves/model-cards/speech-to-text/pulse) for aggregator coverage).
