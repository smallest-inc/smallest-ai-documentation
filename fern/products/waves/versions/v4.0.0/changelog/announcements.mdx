...
<Update label="November 2024">
    ...
    The voices available on waves platform are available via the [Waves API](/v3.0.1/content/api-references/lightning)
</Update> 
...
<Update label="October 2024">
    ...
    You can access lightning via the [Waves API](/v3.0.1/content/api-references/lightning)
</Update>
