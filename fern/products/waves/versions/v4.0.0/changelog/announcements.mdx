...
<Update label="January 2026">
    ...
    Experience the new capabilities of Lightning v3.1 on our [platform](https://app.smallest.ai/dashboard/text-to-speech?utm_source=documentation&utm_medium=changelog) or via the [API](/waves/api-reference/api-reference/text-to-speech/synthesize-lightning-v-31-speech).
</Update>
...
<Update label="May 2025">
    ...
    Experience the new capabilities of Lightning v2 on our [Platform](https://app.smallest.ai/dashboard/text-to-speech).
</Update>
...
<Update label="January 2025">
    ...
    Experience the new capabilities of Lightning Multilingual on our [Platform](https://app.smallest.ai/dashboard/text-to-speech).
</Update>
...
<Update label="December 2024">
    ...
    Experience the new capabilities of Lightning Large via our [Platform](https://app.smallest.ai/dashboard/text-to-speech) or the [API](/waves/api-reference/api-reference/text-to-speech/synthesize-lightning-v-31-speech).
</Update>

<Update label="November 2024">
    ## Introducing Waves
    
    [Waves](https://app.smallest.ai/dashboard/text-to-speech) is our new unified platform for speech synthesis. It supports various models designed for real-time applications such as voicebots.
    ...
    The voices available on waves platform are available via the [Smallest AI API](/waves/api-reference/api-reference/text-to-speech/synthesize-lightning-v-31-speech)
</Update> 
...
<Update label="October 2024">
    ...
    You can access lightning via the [Smallest AI API](/waves/api-reference/api-reference/text-to-speech/synthesize-lightning-v-31-speech)
</Update>
