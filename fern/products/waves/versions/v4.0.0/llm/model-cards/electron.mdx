...
Contact your Smallest AI account manager for current pricing. Prefix-cache discounts apply automatically — see [Prefix Caching](/waves/documentation/llm-electron/prefix-caching). Every response reports `usage.prompt_tokens_details.cached_tokens` so you can audit cache hit rates.
