...
<CardGroup cols={2}>
  ...
  <Card title="WebSocket connection" icon="plug" href="/waves/documentation/speech-to-speech-hydra/web-socket-connection">
  ...
  <Card title="Turn detection & barge-in" icon="wave-pulse" href="/waves/documentation/speech-to-speech-hydra/turn-detection-barge-in">
  ...
  <Card title="Prompting voice agents" icon="masks-theater" href="/waves/documentation/speech-to-speech-hydra/prompting-voice-agents">
