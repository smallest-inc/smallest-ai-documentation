...
| Field | Type | Notes |
|---|---|---|
| `instructions` | string | System prompt. See [Prompting voice agents](/waves/documentation/speech-to-speech-hydra/prompting-voice-agents). |
...
- [Audio I/O](/waves/documentation/speech-to-speech-hydra/audio-i-o) — what to put in `input_audio_buffer.append` and how to play `response.output_audio.delta`
- [Turn detection & barge-in](/waves/documentation/speech-to-speech-hydra/turn-detection-barge-in) — how speech events fire and how to handle interruption on the client
