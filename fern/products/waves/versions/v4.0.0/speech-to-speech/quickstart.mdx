...
<CardGroup cols={2}>
  ...
  <Card title="Audio I/O" icon="waveform-lines" href="/waves/documentation/speech-to-speech-hydra/audio-i-o">
    Input PCM16, output rate negotiation, browser AudioWorklet.
  </Card>
  <Card title="Turn detection & barge-in" icon="wave-square" href="/waves/documentation/speech-to-speech-hydra/turn-detection-barge-in">
