...
- [Pulse Pro model card](/models/model-cards/speech-to-text/pulse-pro)
- [Speech-to-Text quickstart](/models/documentation/speech-to-text-pulse/pre-recorded/quickstart) covers both models.
