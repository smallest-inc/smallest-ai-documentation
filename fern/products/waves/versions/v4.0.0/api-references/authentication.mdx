...
To access our API, you need an API key. You can generate your API key by visiting the [Smallest AI Console](https://app.smallest.ai/dashboard/settings/apikeys?utm_source=documentation&utm_medium=api-references).
...
For more details, visit our [API Documentation](/v4.0.0/content/getting-started/authentication#model-overview).
