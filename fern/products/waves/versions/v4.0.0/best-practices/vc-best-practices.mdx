...
Cloned voices follow the same language group routing rules as standard synthesis. See [Code-Switching](/models/model-cards/text-to-speech/lightning-v-3-1#code-switching) for details on Indic and Global group restrictions.
