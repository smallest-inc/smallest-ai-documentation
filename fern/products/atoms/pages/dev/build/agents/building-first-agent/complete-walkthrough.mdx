...
<CardGroup cols={2}>
  <Card title="Prompts & Personality" icon="message" href="/atoms/developer-guide/build/agent-crews/llm/prompts">
    Craft better system prompts and agent personas.
  </Card>
  <Card title="Tools Deep Dive" icon="wrench" href="/atoms/developer-guide/build/agent-crews/tools/defining-tools">
