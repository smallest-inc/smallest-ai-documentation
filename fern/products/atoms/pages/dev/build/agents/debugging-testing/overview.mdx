...
<CardGroup cols={2}>
  <Card title="Logging" icon="scroll" href="/atoms/developer-guide/build/agents/operations/logging-and-observability">
    Trace execution flow and debug issues.
  </Card>
  <Card title="Common Issues" icon="bug" href="/atoms/developer-guide/build/agents/operations/common-issues">
