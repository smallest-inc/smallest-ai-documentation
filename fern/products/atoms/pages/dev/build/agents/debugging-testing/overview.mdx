...
<CardGroup cols={2}>
  <Card title="Logging" icon="scroll" href="/voice-agents/developer-guide/operate/testing-debugging/logging-observability">
    Trace execution flow and debug issues.
  </Card>
  <Card title="Common Issues" icon="bug" href="/voice-agents/developer-guide/operate/testing-debugging/common-issues">
