...
<Card title="Learn More" icon="shapes" href="/atoms/developer-guide/get-started/agent-crew-core-concepts/nodes">
...
<CardGroup cols={2}>
  <Card title="Configuration" icon="sliders" href="/atoms/developer-guide/build/agent-crews/llm/overview">
    Set up prompts and LLM settings.
  </Card>
  <Card title="Tools & Functions" icon="wrench" href="/atoms/developer-guide/build/agent-crews/tools/overview">
    Give your agent actions and data access.
  </Card>
  <Card title="Patterns" icon="diagram-project" href="/atoms/developer-guide/build/agent-crews/patterns/conversation-flow-design">
