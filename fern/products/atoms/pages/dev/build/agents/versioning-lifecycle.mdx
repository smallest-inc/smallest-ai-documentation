...
For the dashboard equivalent and a deeper conceptual overview, see [Agent Versioning](/voice-agents/platform/features/versioning).
...
<CardGroup cols={2}>
  <Card title="Dashboard Walkthrough" icon="browser" href="/voice-agents/platform/features/versioning">
