...
For the dashboard equivalent and a deeper conceptual overview, see [Agent Versioning](/atoms/atoms-platform/features/versioning).
...
<CardGroup cols={2}>
  <Card title="Dashboard Walkthrough" icon="browser" href="/atoms/atoms-platform/features/versioning">
    Same lifecycle through the visual editor, with screenshots.
  </Card>
  <Card title="Outbound Calls" icon="phone" href="/atoms/developer-guide/build/calling/outbound-calls">
