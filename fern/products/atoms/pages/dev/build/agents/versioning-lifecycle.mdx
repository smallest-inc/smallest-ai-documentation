...
<CardGroup cols={2}>
  <Card title="Dashboard Walkthrough" icon="browser" href="/voice-agents/platform/create-agent/agent-settings/versioning">
    Same lifecycle through the visual editor, with screenshots.
  </Card>
  <Card title="Outbound Calls" icon="phone" href="/voice-agents/developer-guide/build/calling/outbound-calls">
