...
```python
class DataCollectionAgent(OutputSwarmNode):
    def __init__(self):
...
```python
class ProgressAgent(OutputSwarmNode):
    def __init__(self):
...
class PersistentAgent(OutputSwarmNode):
    def __init__(self):
...
```python
class ValidationAgent(OutputSwarmNode):
    def __init__(self):
