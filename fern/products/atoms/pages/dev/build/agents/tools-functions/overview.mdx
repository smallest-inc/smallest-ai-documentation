...
<CardGroup cols={2}>
  <Card title="Defining Tools" icon="code" href="/voice-agents/developer-guide/build/agent-crews/tools/defining-tools">
    The `@function_tool` decorator, docstrings, and type hints.
  </Card>
  <Card title="Executing Tools" icon="play" href="/voice-agents/developer-guide/build/agent-crews/tools/executing-tools">
    ToolRegistry, handling calls, and feeding results back.
  </Card>
  <Card title="Built-in Actions" icon="bolt" href="/voice-agents/developer-guide/build/agent-crews/tools/built-in-tools">
