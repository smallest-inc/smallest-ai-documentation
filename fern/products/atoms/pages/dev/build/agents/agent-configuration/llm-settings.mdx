...
<Tip>
  ...
  → [Waves Voice Models](https://docs.smallest.ai/waves/documentation/getting-started/models)
</Tip>

### Voice Cloning

Create custom voices from audio samples:
→ [Waves Voice Cloning Guide](https://docs.smallest.ai/waves/documentation/voice-cloning/types-of-cloning)
