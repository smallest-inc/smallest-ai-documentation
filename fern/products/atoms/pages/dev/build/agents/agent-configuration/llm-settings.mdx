...
| `quinn` | Female, clear American English |
| `aarush` | Male, Hindi + Indian English |
| `rachel` | Female, neutral American English |

<Tip>
  For the complete Waves voice library with audio samples:
  → [Waves Voice Models](/models/documentation/getting-started/models)
</Tip>

### Voice Cloning

Create custom voices from audio samples:
→ [Waves Voice Cloning Guide](/models/documentation/voice-cloning/instant-clone-ui)
