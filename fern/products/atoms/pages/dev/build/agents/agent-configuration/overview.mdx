...
<CardGroup cols={2}>
  <Card title="Prompts" icon="message" href="/voice-agents/developer-guide/build/agent-crews/llm/prompts">
    Craft effective system prompts that define behavior.
  </Card>
  <Card title="LLM Settings" icon="brain" href="/voice-agents/developer-guide/build/agent-crews/llm/llm-settings">
    Model selection, temperature, and streaming.
  </Card>
  <Card title="Bring Your Own Model" icon="server" href="/voice-agents/developer-guide/build/agent-crews/llm/byom">
