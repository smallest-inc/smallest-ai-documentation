...
1. **API Key** — Get from [app.smallest.ai](https://app.smallest.ai)
...
<CardGroup cols={2}>
  <Card title="Outbound Calls" icon="phone-arrow-up-right" href="/voice-agents/developer-guide/build/calling/outbound-calls">
