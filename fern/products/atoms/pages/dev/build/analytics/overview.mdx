...
<CardGroup cols={2}>
  <Card title="Call Metrics" icon="phone" href="/atoms/developer-guide/build/analytics/call-metrics">
    Retrieve calls, transcripts, recordings, and performance data.
  </Card>
  <Card title="Post-Call Analytics" icon="chart-line" href="/atoms/developer-guide/build/analytics/post-call-analytics">
