...
<CardGroup cols={2}>
  <Card title="Call Metrics" icon="phone" href="/voice-agents/developer-guide/operate/analytics/call-metrics">
    Retrieve calls, transcripts, recordings, and performance data.
  </Card>
  <Card title="Post-Call Analytics" icon="chart-line" href="/voice-agents/developer-guide/operate/analytics/post-call-analytics">
