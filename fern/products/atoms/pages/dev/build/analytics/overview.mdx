...
<CardGroup cols={2}>
  <Card title="Call Metrics" icon="phone" href="/atoms/developer-guide/operate/analytics/call-metrics">
    Retrieve calls, transcripts, recordings, and performance data.
  </Card>
  <Card title="Post-Call Analytics" icon="chart-line" href="/atoms/developer-guide/operate/analytics/post-call-analytics">
