...
call = CallAnalytics()  # reads SMALLEST_API_KEY from the environment
...
from smallestai.atoms.helpers import Audience, Campaign, CallAnalytics
...
agent = client.atoms.agents.create_agent(
    ...
    global_prompt="You are a sales agent. Ask if interested and get their name.",
