...
- **Audience ID** — Create one with `create_audience()` ([see Audiences](/voice-agents/developer-guide/build/campaigns/managing-audiences))
...
Full request/response shape: see [`POST /campaign`](/voice-agents/api-reference/api-reference/campaigns/create) in the API reference.
