...
```mermaid
%%{init: {'theme':'base', 'themeVariables': {'primaryColor':'#e6f4f2','primaryBorderColor':'#2A9D8F','primaryTextColor':'#083b4d','lineColor':'#2A9D8F','clusterBkg':'#f5faf9','clusterBorder':'#083b4d','fontFamily':'Inter, system-ui, sans-serif'}}}%%
flowchart LR
    Caller(["Caller"])
...
_Runtime boundary. Smallest handles STT and TTS. Your crew node handles the LLM turn._
...
_One agent runs one live crew build. A CrewSession hosts your nodes per call._
