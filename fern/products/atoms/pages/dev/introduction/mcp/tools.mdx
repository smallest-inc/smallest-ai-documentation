...
subtitle: All 80 tools the Smallest MCP server provides.
description: 'Reference for all 80 tools the Smallest MCP server exposes. The AI editor picks the right tool from your natural-language prompt — you do not call these directly.'
---
