...
description: 'Connect your AI editor to the Smallest AI platform via the MCP server. Talk to your voice agents, debug calls, transcribe audio, and view analytics from inside Cursor, Claude Desktop, or Claude Code.'
---
...
<Tabs>
  ...
  <Tab title="Build">
    ...
    ```
    ```
    Create a multi-agent support line with SOPs for billing, refunds, and order status
    ```
  </Tab>
  <Tab title="Call">
    ```
...
See the full list in the **[Prompt Cookbook](/voice-agents/mcp/using-the-mcp/prompt-cookbook)**.
