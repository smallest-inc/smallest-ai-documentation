...
<CardGroup cols={2}>
  <Card title="Nodes" icon="circle-nodes" href="/atoms/developer-guide/get-started/agent-crew-core-concepts/nodes">
    Processing units that handle events. The brain of your agent logic.
  </Card>
  <Card title="Events" icon="bolt" href="/atoms/developer-guide/get-started/agent-crew-core-concepts/events">
    Messages flowing through the system. Audio, text, and control signals.
  </Card>
  <Card title="Graphs" icon="diagram-project" href="/atoms/developer-guide/get-started/agent-crew-core-concepts/graphs">
    Connect nodes into pipelines. Build complex multi-agent flows.
  </Card>
  <Card title="Sessions" icon="clock" href="/atoms/developer-guide/get-started/agent-crew-core-concepts/sessions">
