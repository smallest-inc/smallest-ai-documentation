...
<Tip>
  Building in the dashboard instead, or want the design model for an agent (which settings to configure, in what order, and why)? See [Build your agent](/voice-agents/build/build-your-agent). This quickstart is the code path; that guide is the platform path.
</Tip>
