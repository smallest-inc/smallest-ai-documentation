...
```
Full STT+TTS pair. Guide + example: **docs.smallest.ai/integrations/live-kit**.
...
maintained guide + runnable example rather than hardcoding: **docs.smallest.ai/integrations/pipecat**.
...
**docs.smallest.ai/integrations/<name>** instead of improvising.
...
Direct integration guides: [Pipecat](/integrations/agent-framework/pipecat) · [LiveKit](/integrations/agent-framework/live-kit) · [all model integrations](/integrations/agent-framework/live-kit).
