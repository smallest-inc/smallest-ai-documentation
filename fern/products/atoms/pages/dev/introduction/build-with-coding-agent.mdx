...
- Pipecat has first-party TTS and STT services in `pipecat-ai[smallest]` (`SmallestTTSService`, `SmallestSTTService`); use those rather than hand-rolling a WebSocket client.
