...
<CardGroup cols={1}>
  <Card title="Hearthside — React Native voice agent app" icon="mobile-screen" href="https://github.com/smallest-inc/cookbook/tree/main/voice-agents/atoms_hearthside">
