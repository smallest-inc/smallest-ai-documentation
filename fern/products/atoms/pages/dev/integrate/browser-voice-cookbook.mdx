...
<Info>
  ...
  [Agent Web SDK](/voice-agents/platform/integrate/web-socket-sdk) reference.
</Info>
...
<CardGroup cols={2}>
  <Card title="Agent Web SDK reference" icon="js" href="/voice-agents/platform/integrate/web-socket-sdk">
