...
[Register Call](/api-reference/voice-agents/realtime-agent/register-call) and
[Realtime Agent WebSocket](/api-reference/voice-agents/realtime-agent/realtime-agent)
