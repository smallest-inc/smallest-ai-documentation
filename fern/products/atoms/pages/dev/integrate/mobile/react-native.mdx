...
| `interruption` | User barged in during the agent turn. Drop the playback queue and wait for a new `agent.start_talking`. |
...
<CardGroup cols={2}>
  ...
  <Card title="WebSocket SDK (browser)" icon="code" href="/atoms/atoms-platform/integrate/web-socket-sdk">
