...
The browser [Agent Web SDK](/atoms/atoms-platform/integrate/web-socket-sdk) cannot be used here. It calls `navigator.mediaDevices.getUserMedia` and the Web Audio API, both of which are DOM APIs and unavailable in the React Native JavaScript runtime.
...
For iOS-only apps with strict binary-size or battery budgets, prefer the [iOS (Swift)](/atoms/atoms-platform/developer/mobile-integrations/i-os-swift) native path. For Flutter, see the [Flutter](/atoms/atoms-platform/integrate/mobile-integrations/flutter) guide.
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Web SDK" icon="code" href="/atoms/atoms-platform/integrate/web-socket-sdk">
    The JavaScript SDK for browser runtimes.
  </Card>
  <Card title="iOS (Swift)" icon="apple" href="/atoms/atoms-platform/developer/mobile-integrations/i-os-swift">
