...
Flutter applications integrate with the Atoms agent over the [raw WebSocket protocol](/voice-agents/api-reference/api-reference/realtime-agent/realtime-agent).
...
For single-platform native apps, the [iOS (Swift)](/voice-agents/platform/developer/mobile-integrations/i-os-swift) guide gives you full platform control with fewer intermediaries.
