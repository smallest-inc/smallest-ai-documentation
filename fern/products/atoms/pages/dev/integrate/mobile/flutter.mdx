...
For single-platform native apps, the [iOS (Swift)](/atoms/atoms-platform/developer/mobile-integrations/i-os-swift) guide gives you full platform control with fewer intermediaries.
