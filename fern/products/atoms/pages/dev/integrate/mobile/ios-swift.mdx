...
Native iOS applications integrate with the Atoms agent over the [raw WebSocket protocol](/voice-agents/api-reference/api-reference/realtime-agent/realtime-agent) with zero third-party dependencies.
...
If your app is primarily React Native, the [React Native](/voice-agents/platform/developer/mobile-integrations/react-native) guide is simpler. For Flutter, see [Flutter](/voice-agents/platform/developer/mobile-integrations/flutter).
...
<CardGroup cols={2}>
  ...
  <Card title="React Native" icon="react" href="/voice-agents/platform/developer/mobile-integrations/react-native">
