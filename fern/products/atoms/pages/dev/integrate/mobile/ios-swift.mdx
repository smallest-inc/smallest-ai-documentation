...
If your app is primarily React Native, the [React Native](/voice-agents/platform/integrate/mobile-integrations/react-native) guide is simpler. For Flutter, see [Flutter](/voice-agents/platform/integrate/mobile-integrations/flutter).
...
<CardGroup cols={2}>
  ...
  <Card title="React Native" icon="react" href="/voice-agents/platform/integrate/mobile-integrations/react-native">
