...
For the full API surface (configuration, methods, events, push-to-talk, text input, error handling, smoke test), see the [Agent Web SDK](/voice-agents/platform/integrate/web-socket-sdk) reference.
...
Full reference: [GET voices](/models/api-reference/api-reference/voices/get-waves-voices). The [Voice Cloning dashboard](https://app.smallest.ai/dashboard/voice-cloning) also lists available voice IDs in a UI.
