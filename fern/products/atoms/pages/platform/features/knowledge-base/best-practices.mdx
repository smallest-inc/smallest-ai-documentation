...
<CardGroup cols={2}>
  <Card title="Webhooks" icon="webhook" href="/voice-agents/integrate/webhooks">
    Learn about event notifications
  </Card>
  <Card title="Variables Reference" icon="brackets-curly" href="/voice-agents/build/variables">
