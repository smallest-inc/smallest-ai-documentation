...
version_id = published["data"]["version"]["_id"]
...
<CardGroup cols={2}>
  <Card title="Versioning Lifecycle (Developer Guide)" icon="code-branch" href="/atoms/developer-guide/build/agents/versioning-lifecycle">
