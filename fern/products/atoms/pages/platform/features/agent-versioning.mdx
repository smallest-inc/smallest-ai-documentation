...
<CardGroup cols={2}>
  <Card title="Versioning Lifecycle (Developer Guide)" icon="code-branch" href="/voice-agents/developer-guide/build/agent-crews/versioning-lifecycle">
    Same flow in curl + Python with copy-pasteable snippets.
  </Card>
  <Card title="Post-Call Metrics" icon="chart-line" href="/voice-agents/platform/features/post-call-metrics">
