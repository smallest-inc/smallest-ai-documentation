...
subtitle: "**Prompt Scoring** analyses your agent's system prompt across 11 quality dimensions and returns an overall score (0–100)"
description: "Get instant, AI-powered feedback on your agent's system prompt quality."
slug: /voice-agents/platform/create-agent/agent-settings/prompt-scoring
---
...
→ [Full API reference](/voice-agents/api-reference/prompt-scoring/score-a-prompt)
