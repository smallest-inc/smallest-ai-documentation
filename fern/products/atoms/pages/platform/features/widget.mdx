...
title: "Widget"
sidebarTitle: "Widget"
subtitle: "The **widget** lets visitors talk to your agent without leaving your site. They can either text or speak, right from their browser."
description: "Embed your voice agent directly on your website."
slug: /voice-agents/platform/create-agent/agent-settings/widget
---

<Frame caption="Widget configuration page">
  ![Widget configuration](../building-agents/images/widget-full.png)
</Frame>
...
<Tabs>
  <Tab title="Tiny">
    <Frame caption="Tiny variant">
      ![Tiny widget](../building-agents/images/widget-tiny.png)
    </Frame>
  ...
  <Tab title="Compact">
    <Frame caption="Compact variant">
      ![Compact widget](../building-agents/images/widget-compact.png)
    </Frame>
  ...
  <Tab title="Full">
    <Frame caption="Full variant">
      ![Full widget](../building-agents/images/widget-full-variant.png)
    </Frame>
...
<Card title="Adding to Your Website" href="/voice-agents/platform/create-agent/agent-settings/widget">
