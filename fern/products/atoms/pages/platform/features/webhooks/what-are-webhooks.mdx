...
<CardGroup cols={2}>
  <Card title="Creating Endpoints" icon="plus" href="/atoms/atoms-platform/features/webhooks/creating-endpoints">
    Set up your webhook endpoints
  </Card>
  <Card title="Event Payloads" icon="code" href="/atoms/atoms-platform/features/webhooks/event-payloads">
