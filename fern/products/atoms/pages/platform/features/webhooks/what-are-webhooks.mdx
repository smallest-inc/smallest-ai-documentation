...
→ See: [Event Payloads](/voice-agents/integrate/webhooks) for detailed schemas
...
<CardGroup cols={2}>
  <Card title="Creating Endpoints" icon="plus" href="/voice-agents/integrate/webhooks">
    Set up your webhook endpoints
  </Card>
  <Card title="Event Payloads" icon="code" href="/voice-agents/integrate/webhooks">
