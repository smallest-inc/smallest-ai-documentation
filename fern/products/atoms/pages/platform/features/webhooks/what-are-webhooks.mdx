...
→ See: [Event Payloads](/voice-agents/platform/features/webhooks) for detailed schemas
...
<CardGroup cols={2}>
  <Card title="Creating Endpoints" icon="plus" href="/voice-agents/platform/features/webhooks">
    Set up your webhook endpoints
  </Card>
  <Card title="Event Payloads" icon="code" href="/voice-agents/platform/features/webhooks">
