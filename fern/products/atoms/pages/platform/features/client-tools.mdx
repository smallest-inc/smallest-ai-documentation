...
<Warning>
Client tools only run on **websocket sessions** (webcall, widget). On phone calls the definition is dropped — a phone agent can't reach your app. Use an [API tool](/voice-agents/build/tools/api-tool) for anything that must work over telephony.
</Warning>
