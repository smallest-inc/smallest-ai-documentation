...
<Note>
Custom API and client tools are now **reusable across agents** — build one in the [Tools library](/voice-agents/platform/create-agent/tools) and reference it anywhere. This page covers the per-agent Tools tab and built-in System tools.
</Note>
