...
<Steps>
  <Step title="Create a tool once">
    Click **Add tool** and pick a type — **API tool** (calls your API) or **Client tool** (runs in your app over the websocket). Configure it and save. It now lives in the library. See [API tool](/voice-agents/build/tools/api-tool) and [Client tools](/voice-agents/build/tools/client-tools) for the builders.
  </Step>
...
<CardGroup cols={2}>
  <Card title="API tool" href="/voice-agents/build/tools/api-tool">
  ...
  <Card title="Client tools" href="/voice-agents/build/tools/client-tools">
    Tools your own app runs over the websocket
  </Card>
  <Card title="Tools overview" href="/voice-agents/build/tools/agent-tools-tab">
