...
<CardGroup cols={2}>
  <Card title="Single Prompt" icon="message" href="/atoms/atoms-platform/single-prompt-agents/configuration-panel/api-calls">
    API Calls in Configuration Panel
  </Card>
  <Card title="Conversational Flow" icon="diagram-project" href="/atoms/atoms-platform/conversational-flow-agents/workflow-tab/node-types#api-call-node">
