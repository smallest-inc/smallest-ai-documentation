...
<CardGroup cols={2}>
  <Card title="Create Agent" icon="message" href="/voice-agents/platform/create-agent/agent-config">
    API Calls in Configuration Panel
  </Card>
  <Card title="Conversational Flow" icon="diagram-project" href="/voice-agents/platform/conversational-flow-agents/workflow-tab/node-types#api-call-node">
