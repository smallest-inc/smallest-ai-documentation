...
**Secrets** hold the API keys and tokens your [API tools](/voice-agents/build/tools/api-tool) authenticate with. Instead of pasting a raw key into a tool, you store it once in the vault and reference it by name from the tool's **Auth** tab.
