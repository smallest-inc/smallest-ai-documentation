...
Filters live in the **Filter By** dropdown and combine with each other. You can filter by conversation type, status, end reason, call type (all attempts, retries only, initial attempts only), and duration.
