...
<CardGroup cols={2}>
  <Card title="API Calls in Single Prompt" icon="terminal" href="/atoms/atoms-platform/features/api-calls">
    How to set up API calls for Single Prompt agents
  </Card>
  <Card title="API Calls in Convo Flow" icon="diagram-project" href="/atoms/atoms-platform/features/api-calls">
...
<CardGroup cols={2}>
  <Card title="Creating API Calls" icon="plus" href="/atoms/atoms-platform/features/api-calls">
    Step-by-step setup guide
  </Card>
  <Card title="Common Integrations" icon="plug" href="/atoms/atoms-platform/features/api-calls">
