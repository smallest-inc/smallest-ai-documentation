...
<CardGroup cols={2}>
  <Card title="API Calls in Single Prompt" icon="terminal" href="/atoms/atoms-platform/features/api-calls/single-prompt">
    How to set up API calls for Single Prompt agents
  </Card>
  <Card title="API Calls in Convo Flow" icon="diagram-project" href="/atoms/atoms-platform/features/api-calls/convo-flow">
...
<CardGroup cols={2}>
  <Card title="Creating API Calls" icon="plus" href="/atoms/atoms-platform/features/api-calls/creating">
    Step-by-step setup guide
  </Card>
  <Card title="Common Integrations" icon="plug" href="/atoms/atoms-platform/features/api-calls/common-integrations">
