...
<CardGroup cols={2}>
  <Card title="API Calls in Single Prompt" icon="terminal" href="/voice-agents/platform/features/api-calls">
    How to set up API calls for Single Prompt agents
  </Card>
  <Card title="API Calls in Convo Flow" icon="diagram-project" href="/voice-agents/platform/features/api-calls">
...
<CardGroup cols={2}>
  <Card title="Creating API Calls" icon="plus" href="/voice-agents/platform/features/api-calls">
    Step-by-step setup guide
  </Card>
  <Card title="Common Integrations" icon="plug" href="/voice-agents/platform/features/api-calls">
