...
<CardGroup cols={2}>
  <Card title="Single Prompt APIs" icon="terminal" href="/voice-agents/platform/features/api-calls">
    Configure APIs for Single Prompt agents
  </Card>
  <Card title="Convo Flow APIs" icon="diagram-project" href="/voice-agents/platform/features/api-calls">
