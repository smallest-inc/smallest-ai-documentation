...
<Tip>
  The voice itself, and the language(s) your agent speaks, are chosen on the [Prompt tab](/voice-agents/build/prompt), not here. The Speech tab only tunes how that chosen voice behaves.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Agent Configuration" href="/voice-agents/build/agent-settings">
