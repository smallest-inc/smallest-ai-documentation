...
slug: /voice-agents/platform/create-agent/developer/integrations
---
...
For services not listed, use [API Calls](/voice-agents/platform/create-agent/agent-config) to connect to any REST API.

<CardGroup cols={2}>
  <Card title="Create Agent" href="/voice-agents/platform/create-agent/agent-config">
    Connect to any external service via API Calls
  </Card>
