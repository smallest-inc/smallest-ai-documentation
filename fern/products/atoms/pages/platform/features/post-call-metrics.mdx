...
<CardGroup cols={2}>
  <Card title="Conversation Logs" icon="scroll" href="/voice-agents/platform/monitor/conversation-logs">
    View metrics for individual calls
  </Card>
  <Card title="Analytics Dashboard" icon="chart-line" href="/voice-agents/platform/monitor/analytics">
