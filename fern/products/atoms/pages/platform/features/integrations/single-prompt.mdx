...
<CardGroup cols={2}>
  <Card title="Convo Flow Integrations" icon="diagram-project" href="/atoms/atoms-platform/features/integrations">
    More control with node-based flows
  </Card>
  <Card title="API Call Setup" icon="code" href="/atoms/atoms-platform/features/api-calls">
