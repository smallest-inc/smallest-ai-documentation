...
<CardGroup cols={2}>
  <Card title="Convo Flow Integrations" icon="diagram-project" href="/voice-agents/integrate/integrations">
    More control with node-based flows
  </Card>
  <Card title="API Call Setup" icon="code" href="/voice-agents/build/api-calls">
