...
<CardGroup cols={2}>
  <Card title="HubSpot Integration" icon="hubspot" href="/voice-agents/platform/features/integrations">
    Set up HubSpot instead
  </Card>
  <Card title="Custom API Calls" icon="code" href="/voice-agents/platform/features/api-calls">
