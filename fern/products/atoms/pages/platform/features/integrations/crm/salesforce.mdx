...
<CardGroup cols={2}>
  <Card title="HubSpot Integration" icon="hubspot" href="/atoms/atoms-platform/features/integrations/crm/hubspot">
    Set up HubSpot instead
  </Card>
  <Card title="Custom API Calls" icon="code" href="/atoms/atoms-platform/features/api-calls/common-integrations">
