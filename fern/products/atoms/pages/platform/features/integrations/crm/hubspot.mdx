...
<CardGroup cols={2}>
  <Card title="Salesforce Integration" icon="salesforce" href="/voice-agents/integrate/integrations">
    Set up Salesforce instead
  </Card>
  <Card title="Calendar Integration" icon="calendar" href="/voice-agents/integrate/integrations">
