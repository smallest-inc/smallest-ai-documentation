...
<CardGroup cols={2}>
  <Card title="Salesforce Integration" icon="salesforce" href="/voice-agents/platform/features/integrations">
    Set up Salesforce instead
  </Card>
  <Card title="Calendar Integration" icon="calendar" href="/voice-agents/platform/features/integrations">
