...
<CardGroup cols={2}>
  <Card title="Salesforce Integration" icon="salesforce" href="/atoms/atoms-platform/features/integrations/crm/salesforce">
    Set up Salesforce instead
  </Card>
  <Card title="Calendar Integration" icon="calendar" href="/atoms/atoms-platform/features/integrations/calendar">
