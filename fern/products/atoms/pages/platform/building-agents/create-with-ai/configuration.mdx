...
**Note:** You must create a Knowledge Base first before it appears here. See [Knowledge Base](/voice-agents/build/knowledge-base) for setup.
...
<CardGroup cols={2}>
  <Card title="Writing the Four Prompts" icon="list-ol" href="/voice-agents/build/get-started">
    Master each required prompt
  </Card>
  <Card title="Using Templates" icon="copy" href="/voice-agents/build/get-started">
