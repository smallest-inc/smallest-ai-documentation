...
**Note:** You must create a Knowledge Base first before it appears here. See [Knowledge Base](/voice-agents/platform/features/knowledge-base) for setup.
...
<CardGroup cols={2}>
  <Card title="Writing the Four Prompts" icon="list-ol" href="/voice-agents/platform/single-prompt-agents/creating-your-agent/ai-assisted">
    Master each required prompt
  </Card>
  <Card title="Using Templates" icon="copy" href="/voice-agents/platform/single-prompt-agents/creating-your-agent/from-template">
