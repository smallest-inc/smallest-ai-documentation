...
<CardGroup cols={2}>
  <Card title="Writing the Four Prompts" icon="list-ol" href="/voice-agents/platform/create-agent/get-started">
    Master each required prompt
  </Card>
  <Card title="Using Templates" icon="copy" href="/voice-agents/platform/create-agent/get-started">
