...
<CardGroup cols={2}>
  <Card title="Using Templates" icon="copy" href="/atoms/atoms-platform/single-prompt-agents/creating-your-agent/from-template">
    Start from pre-built examples
  </Card>
  <Card title="How It Works" icon="wand-magic-sparkles" href="/atoms/atoms-platform/single-prompt-agents/creating-your-agent/ai-assisted">
