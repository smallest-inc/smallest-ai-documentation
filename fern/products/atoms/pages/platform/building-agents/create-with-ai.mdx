...
<CardGroup cols={2}>
  <Card title="Single Prompt Setup" icon="message-lines" href="/voice-agents/platform/single-prompt-agents/overview">
    Refine your Single Prompt agent
  </Card>
  <Card title="Conversational Flow Setup" icon="diagram-project" href="/voice-agents/platform/conversational-flow-agents/overview">
    <Badge color="yellow">Deprecated</Badge>

    Master workflow building
  </Card>
  <Card title="Configure Your Agent" icon="sliders" href="/voice-agents/platform/single-prompt-agents/overview">
    Voice, model, and features
  </Card>
  <Card title="Test Your Agent" icon="flask" href="/voice-agents/platform/monitor/evaluations">
