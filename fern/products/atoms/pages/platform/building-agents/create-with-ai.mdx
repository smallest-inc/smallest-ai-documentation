...
<CardGroup cols={2}>
  <Card title="Single Prompt Setup" icon="message-lines" href="/voice-agents/platform/create-agent/get-started">
    Refine your Single Prompt agent
  </Card>
  <Card title="Conversational Flow Setup" icon="diagram-project" href="/voice-agents/platform/create-agent/get-started">
    <Badge color="yellow">Deprecated</Badge>

    Master workflow building
  </Card>
  <Card title="Configure Your Agent" icon="sliders" href="/voice-agents/platform/create-agent/get-started">
