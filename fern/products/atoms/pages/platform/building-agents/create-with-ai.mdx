...
<CardGroup cols={2}>
  <Card title="Single Prompt Setup" icon="message-lines" href="/atoms/atoms-platform/single-prompt-agents/overview">
    Refine your Single Prompt agent
  </Card>
  <Card title="Conversational Flow Setup" icon="diagram-project" href="/atoms/atoms-platform/conversational-flow-agents/overview">
    <Badge color="yellow">Deprecated</Badge>

    Master workflow building
  </Card>
  <Card title="Configure Your Agent" icon="sliders" href="/atoms/atoms-platform/single-prompt-agents/overview">
