...
<CardGroup cols={2}>
  <Card title="How Locking Works" icon="lock" href="/voice-agents/platform/monitor/locking">
    Technical details of the locking mechanism
  </Card>
  <Card title="Version Management" icon="code-branch" href="/voice-agents/platform/monitor/locking">
