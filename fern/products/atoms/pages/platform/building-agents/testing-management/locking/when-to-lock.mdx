...
<CardGroup cols={2}>
  <Card title="How Locking Works" icon="lock" href="/voice-agents/build/versioning">
    Technical details of the locking mechanism
  </Card>
  <Card title="Version Management" icon="code-branch" href="/voice-agents/build/versioning">
