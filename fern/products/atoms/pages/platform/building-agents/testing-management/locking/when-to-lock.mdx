...
<CardGroup cols={2}>
  <Card title="How Locking Works" icon="lock" href="/atoms/atoms-platform/monitor/locking">
    Technical details of the locking mechanism
  </Card>
  <Card title="Version Management" icon="code-branch" href="/atoms/atoms-platform/monitor/locking">
