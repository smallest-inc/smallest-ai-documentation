...
<Note>
The Prompt Section is only available for **Single Prompt agents**. Conversational Flow agents configure voices in [Agent Settings → Voice tab](/voice-agents/platform/single-prompt-agents/agent-settings/voice-settings).
</Note>

<Frame caption="The Voice Picker">
  ![Voice picker](../images/voice-picker.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Voice Settings" icon="sliders" href="/voice-agents/platform/single-prompt-agents/agent-settings/voice-settings">
    Speed, pronunciation & turn-taking
  </Card>
  <Card title="Language Selection" icon="globe" href="/voice-agents/platform/single-prompt-agents/agent-settings/language-selection">
