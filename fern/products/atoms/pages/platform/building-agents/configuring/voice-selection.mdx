...
<Note>
The Prompt Section is only available for **Single Prompt agents**. Conversational Flow agents configure voices in [Agent Settings → Voice tab](/voice-agents/build/agent-settings).
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Language Selection" href="/voice-agents/build/agent-settings">
