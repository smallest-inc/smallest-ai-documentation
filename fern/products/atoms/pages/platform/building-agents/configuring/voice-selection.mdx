...
<Note>
The Prompt Section is only available for **Single Prompt agents**. Conversational Flow agents configure voices in [Agent Settings → Voice tab](/voice-agents/platform/create-agent/agent-config).
</Note>
...
<CardGroup cols={2}>
  <Card title="Voice Settings" icon="sliders" href="/voice-agents/platform/create-agent/agent-config">
    Speed, pronunciation & turn-taking
  </Card>
  <Card title="Language Selection" icon="globe" href="/voice-agents/platform/create-agent/agent-config">
