...
<Frame caption="Add Transfer Call modal">
  ![Transfer call modal](../images/transfer-call-modal.png)
</Frame>
...
<Frame caption="Warm transfer options">
  ![Warm transfer options](../images/transfer-call-warm.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Webhooks" icon="webhook" href="/voice-agents/platform/single-prompt-agents/agent-settings/webhooks">
