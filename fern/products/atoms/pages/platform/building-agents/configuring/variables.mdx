...
<Tabs>
  <Tab title="User Defined">
    <Frame caption="User Defined variables">
      ![User defined variables](../images/variables-user.png)
    </Frame>
  ...
  <Tab title="System">
    <Frame caption="System variables">
      ![System variables](../images/variables-system.png)
    </Frame>
  ...
  <Tab title="API">
    <Frame caption="API variables">
      ![API variables](../images/variables-api.png)
    </Frame>
    ...
    → See [API Calls](/voice-agents/platform/single-prompt-agents/configuration-panel/api-calls)
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="API Calls" icon="plug" href="/voice-agents/platform/single-prompt-agents/configuration-panel/api-calls">
