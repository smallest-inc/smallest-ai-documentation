...
<Tabs>
  ...
  <Tab title="API">
    ...
    → See [API Calls](/voice-agents/build/agent-settings)
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  <Card title="API Calls" icon="plug" href="/voice-agents/build/agent-settings">
    Fetch data from external APIs
  </Card>
  <Card title="Writing Prompts" icon="pen" href="/voice-agents/build/prompt">
