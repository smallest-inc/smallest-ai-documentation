...
<Note>
You need to purchase or configure phone numbers before they appear here. See [Phone Numbers](/voice-agents/telephony/phone-numbers) to get started.
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="Campaigns" href="/voice-agents/telephony/campaigns">
