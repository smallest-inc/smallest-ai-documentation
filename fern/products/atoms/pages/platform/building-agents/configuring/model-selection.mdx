...
<Note>
The Prompt Section is only available for **Single Prompt agents**. Conversational Flow agents configure models in [Agent Settings → Model tab](/voice-agents/platform/single-prompt-agents/agent-settings/model-settings).
</Note>

<Frame caption="Model selection dropdown">
  ![Model dropdown](../images/model-dropdown.png)
</Frame>
