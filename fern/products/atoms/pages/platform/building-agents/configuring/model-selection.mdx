...
<Note>
The Prompt Section is only available for **Single Prompt agents**. Conversational Flow agents configure models in [Agent Settings → Model tab](/voice-agents/platform/create-agent/agent-config).
</Note>
