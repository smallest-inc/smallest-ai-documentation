...
<Frame caption="The Single Prompt agent editor">
  ![Single Prompt editor](../images/sp-editor-full.png)
</Frame>
...
<Frame caption="The Prompt Section">
  ![Prompt section](../images/prompt-section.png)
</Frame>
...
→ [Model Selection](/voice-agents/platform/single-prompt-agents/prompt-section/model-selection) · [Voice Selection](/voice-agents/platform/single-prompt-agents/prompt-section/voice-selection) · [Language Selection](/voice-agents/platform/single-prompt-agents/agent-settings/language-selection)
...
→ [Writing Effective Prompts](/voice-agents/platform/single-prompt-agents/prompt-section/writing-prompts)
...
<Frame caption="Configuration Panel">
  ![Config panel](../images/config-panel.png)
</Frame>
...
→ [End Call](/voice-agents/platform/single-prompt-agents/configuration-panel/end-call) · [Transfer Call](/voice-agents/platform/single-prompt-agents/configuration-panel/transfer-call) · [Knowledge Base](/voice-agents/platform/single-prompt-agents/configuration-panel/knowledge-base) · [Variables](/voice-agents/platform/single-prompt-agents/configuration-panel/variables) · [API Calls](/voice-agents/platform/single-prompt-agents/configuration-panel/api-calls)
...
→ [Voice Settings](/voice-agents/platform/single-prompt-agents/agent-settings/voice-settings) · [Model Settings](/voice-agents/platform/single-prompt-agents/agent-settings/model-settings) · [Webhooks](/voice-agents/platform/single-prompt-agents/agent-settings/webhooks) · [General Settings](/voice-agents/platform/single-prompt-agents/agent-settings/general-settings) · [Widget](/voice-agents/platform/features/widget) · [Integrations](/voice-agents/platform/features/integrations) · [Post-Call Metrics](/voice-agents/platform/features/post-call-metrics)
...
→ [Testing Your Agent](/voice-agents/platform/monitor/evaluations) · [Conversation Logs](/voice-agents/platform/monitor/conversation-logs) · [Locking Agents](/voice-agents/platform/monitor/locking)
...
<Frame caption="Conversational Flow editor">
  ![Convo Flow editor](../images/cf-editor-full.png)
</Frame>
...
→ [Workflow Builder](/voice-agents/platform/conversational-flow-agents/workflow-tab/workflow-builder)
