...
→ [Model Selection](/atoms/atoms-platform/single-prompt-agents/agent-settings/model-selection) · [Voice Selection](/atoms/atoms-platform/single-prompt-agents/agent-settings/voice-selection) · [Language Selection](/atoms/atoms-platform/single-prompt-agents/agent-settings/language-selection)
...
→ [End Call](/atoms/atoms-platform/single-prompt-agents/agent-settings/end-call) · [Transfer Call](/atoms/atoms-platform/single-prompt-agents/agent-settings/transfer-call) · [Knowledge Base](/atoms/atoms-platform/single-prompt-agents/agent-settings/knowledge-base) · [Variables](/atoms/atoms-platform/single-prompt-agents/configuration-panel/variables) · [API Calls](/atoms/atoms-platform/single-prompt-agents/agent-settings/api-calls)
...
→ [Testing Your Agent](/atoms/atoms-platform/analytics-and-logs/testing) · [Conversation Logs](/atoms/atoms-platform/analytics-and-logs/conversation-logs) · [Locking Agents](/atoms/atoms-platform/analytics-and-logs/locking)
