...
<Frame caption="Post-call metrics dashboard">
  ![Post-call metrics list](../images/post-call-metrics-list.png)
</Frame>
...
<Tabs>
  <Tab title="Disposition Metrics">
    <Frame caption="Create a new metric from scratch">
      ![Disposition metrics](../images/post-call-disposition.png)
    </Frame>
  ...
  <Tab title="Templates">
    <Frame caption="Select from pre-built metrics">
      ![Metric templates](../images/post-call-templates.png)
    </Frame>
