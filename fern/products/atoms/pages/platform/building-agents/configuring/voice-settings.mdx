...
<CardGroup cols={2}>
  <Card title="Model Settings" icon="microchip" href="/voice-agents/platform/create-agent/agent-config">
    Configure AI model and language behavior
  </Card>
  <Card title="Voice Selection" icon="waveform" href="/voice-agents/platform/create-agent/prompt">
