...
<Frame caption="Add Pronunciation modal">
  ![Add pronunciation](../images/add-pronunciation.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Model Settings" icon="microchip" href="/voice-agents/platform/single-prompt-agents/agent-settings/model-settings">
    Configure AI model and language behavior
  </Card>
  <Card title="Voice Selection" icon="waveform" href="/voice-agents/platform/single-prompt-agents/prompt-section/voice-selection">
