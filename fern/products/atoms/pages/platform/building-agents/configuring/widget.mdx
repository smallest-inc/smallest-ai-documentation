...
<Frame caption="Widget configuration page">
  ![Widget configuration](../images/widget-full.png)
</Frame>
...
<Tabs>
  <Tab title="Tiny">
    <Frame caption="Tiny variant">
      ![Tiny widget](../images/widget-tiny.png)
    </Frame>
  ...
  <Tab title="Compact">
    <Frame caption="Compact variant">
      ![Compact widget](../images/widget-compact.png)
    </Frame>
  ...
  <Tab title="Full">
    <Frame caption="Full variant">
      ![Full widget](../images/widget-full-variant.png)
    </Frame>
