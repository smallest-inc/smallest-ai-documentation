...
<Tabs>
  <Tab title="Single Prompt">
    <Frame caption="Model tab for Single Prompt agents">
      ![Model settings - Single Prompt](../images/model-settings-sp.png)
    </Frame>
  ...
  <Tab title="Conversational Flow">
    <Frame caption="Model tab for Conversational Flow agents">
      ![Model settings - Conversational Flow](../images/model-settings-cf.png)
    </Frame>
...
For Single Prompt agents, you can also set the model in the [Prompt Section](/voice-agents/platform/single-prompt-agents/prompt-section/model-selection) dropdown.
...
<Note>
This is only available for Conversational Flow agents. Single Prompt agents define everything in their [main prompt](/voice-agents/platform/single-prompt-agents/prompt-section/writing-prompts).
</Note>
...
<Note>
Single Prompt agents connect knowledge bases via the [Configuration Panel](/voice-agents/platform/single-prompt-agents/configuration-panel/knowledge-base) instead.
</Note>
...
<CardGroup cols={2}>
  <Card title="Voice Settings" icon="volume" href="/voice-agents/platform/single-prompt-agents/agent-settings/voice-settings">
    Speech speed, pronunciation, and detection
  </Card>
  <Card title="Writing Prompts" icon="pen" href="/voice-agents/platform/single-prompt-agents/prompt-section/writing-prompts">
