...
<CardGroup cols={2}>
  <Card title="Voice Settings" href="/voice-agents/platform/create-agent/agent-config">
    Speech speed, pronunciation, and detection
  </Card>
  <Card title="Writing Prompts" href="/voice-agents/platform/create-agent/prompt">
