...
For Single Prompt agents, you can also set the model in the [Prompt Section](/voice-agents/build/prompt) dropdown.
...
<Note>
This is only available for Conversational Flow agents. Single Prompt agents define everything in their [main prompt](/voice-agents/build/prompt).
</Note>
...
<Note>
Single Prompt agents connect knowledge bases via the [Configuration Panel](/voice-agents/build/agent-settings) instead.
</Note>
...
<CardGroup cols={2}>
  <Card title="Voice Settings" href="/voice-agents/build/agent-settings">
    Speech speed, pronunciation, and detection
  </Card>
  <Card title="Writing Prompts" href="/voice-agents/build/prompt">
