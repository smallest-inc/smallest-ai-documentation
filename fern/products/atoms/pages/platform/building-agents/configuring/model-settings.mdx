...
For Single Prompt agents, you can also set the model in the [Prompt Section](/atoms/atoms-platform/single-prompt-agents/agent-settings/model-selection) dropdown.
...
<Note>
Single Prompt agents connect knowledge bases via the [Configuration Panel](/atoms/atoms-platform/single-prompt-agents/agent-settings/knowledge-base) instead.
</Note>
