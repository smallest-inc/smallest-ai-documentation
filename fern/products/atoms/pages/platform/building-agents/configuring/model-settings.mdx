...
For Single Prompt agents, you can also set the model in the [Prompt Section](/voice-agents/platform/create-agent/prompt) dropdown.
...
<Note>
This is only available for Conversational Flow agents. Single Prompt agents define everything in their [main prompt](/voice-agents/platform/create-agent/prompt).
</Note>
...
<Note>
Single Prompt agents connect knowledge bases via the [Configuration Panel](/voice-agents/platform/create-agent/agent-config) instead.
</Note>
...
<CardGroup cols={2}>
  <Card title="Voice Settings" icon="volume" href="/voice-agents/platform/create-agent/agent-config">
    Speech speed, pronunciation, and detection
  </Card>
  <Card title="Writing Prompts" icon="pen" href="/voice-agents/platform/create-agent/prompt">
