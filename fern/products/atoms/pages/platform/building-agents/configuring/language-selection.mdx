...
<Note>
The Prompt Section is only available for **Single Prompt agents**. Conversational Flow agents configure language in [Agent Settings → Model tab](/voice-agents/build/agent-settings).
</Note>
...
<Tip>
**Need multi-language support?** If your agent should switch languages mid-conversation based on what the caller speaks, configure that in [Model Settings](/voice-agents/build/agent-settings).
</Tip>
...
<CardGroup cols={2}>
  <Card title="Voice Selection" href="/voice-agents/build/prompt">
    Pick your agent's voice
  </Card>
  <Card title="Model Settings" href="/voice-agents/build/agent-settings">
