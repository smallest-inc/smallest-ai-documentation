...
<Frame caption="Add End Call modal">
  ![Add end call](../images/end-call-modal.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="General Settings" icon="gear" href="/voice-agents/platform/single-prompt-agents/agent-settings/general-settings">
