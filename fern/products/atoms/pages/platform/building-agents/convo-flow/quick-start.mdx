...
<CardGroup cols={2}>
  ...
  <Card title="Add API Calls" icon="bolt" href="/atoms/atoms-platform/features/api-calls/what-are-api-calls">
  ...
  <Card title="Launch Campaign" icon="megaphone" href="/atoms/atoms-platform/deployment/campaigns/creating">
