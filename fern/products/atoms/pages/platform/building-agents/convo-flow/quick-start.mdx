...
<CardGroup cols={2}>
  <Card title="Master Nodes" icon="sitemap" href="/atoms/atoms-platform/conversational-flow-agents/workflow-tab/node-types">
    Deep dive into each node type
  </Card>
  <Card title="Add API Calls" icon="bolt" href="/atoms/atoms-platform/features/api-calls">
    Connect to external systems
  </Card>
  <Card title="Set Up Phone Number" icon="phone" href="/atoms/atoms-platform/deployment/phone-numbers">
    Make your agent live
  </Card>
  <Card title="Launch Campaign" icon="megaphone" href="/atoms/atoms-platform/deployment/campaigns">
