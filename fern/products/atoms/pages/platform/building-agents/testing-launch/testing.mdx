...
<CardGroup cols={2}>
  <Card title="Conversation Logs" icon="scroll" href="/voice-agents/operate/conversation-logs">
    Review call transcripts
  </Card>
  <Card title="Lock Your Agent" icon="lock" href="/voice-agents/build/versioning">
