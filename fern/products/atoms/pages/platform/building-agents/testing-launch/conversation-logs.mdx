...
<CardGroup cols={2}>
  <Card title="Post-Call Metrics" icon="chart-bar" href="/voice-agents/build/post-call-metrics">
    Define what to track from each call
  </Card>
  <Card title="Testing" icon="flask" href="/voice-agents/operate/evaluations">
    Test your agent
  </Card>
</CardGroup>
