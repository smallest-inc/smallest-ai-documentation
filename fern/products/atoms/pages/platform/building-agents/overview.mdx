...
<CardGroup cols={2}>
  <Card title="Single Prompt Agents" icon="message-lines" href="/voice-agents/platform/create-agent/get-started">
    Flexible conversations powered by one prompt
  </Card>
  <Card title="Conversational Flow Agents" icon="diagram-project" href="/voice-agents/platform/create-agent/get-started">
