...
<CardGroup cols={2}>
  <Card title="Single Prompt Agents" icon="message-lines" href="/atoms/atoms-platform/single-prompt-agents/overview">
    Flexible conversations powered by one prompt
  </Card>
  <Card title="Conversational Flow Agents" icon="diagram-project" href="/atoms/atoms-platform/conversational-flow-agents/overview">
