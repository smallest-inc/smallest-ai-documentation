...
<CardGroup cols={2}>
  <Card title="Single Prompt Agents" icon="message-lines" href="/voice-agents/build/get-started">
    Flexible conversations powered by one prompt
  </Card>
  <Card title="Conversational Flow Agents" icon="diagram-project" href="/voice-agents/build/get-started">
