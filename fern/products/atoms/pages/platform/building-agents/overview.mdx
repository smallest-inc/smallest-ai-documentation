...
<Frame caption="The Create Agent modal">
  ![Create agent modal](images/create-agent-modal.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Single Prompt Agents" icon="message-lines" href="/voice-agents/platform/single-prompt-agents/overview">
    Flexible conversations powered by one prompt
  </Card>
  <Card title="Conversational Flow Agents" icon="diagram-project" href="/voice-agents/platform/conversational-flow-agents/overview">
