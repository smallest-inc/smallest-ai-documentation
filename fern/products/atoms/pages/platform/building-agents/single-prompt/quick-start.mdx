...
For detailed guidance on writing great prompts, see [Writing Prompts](/voice-agents/platform/single-prompt-agents/prompt-section/writing-prompts).
...
<CardGroup cols={2}>
  ...
  <Card title="Set Up Phone Number" icon="phone" href="/voice-agents/platform/deployment/phone-numbers">
    Get a number customers can call
  </Card>
  <Card title="Add Variables" icon="brackets-curly" href="/voice-agents/platform/features/variables">
    Personalize with customer data
  </Card>
  <Card title="Connect APIs" icon="bolt" href="/voice-agents/platform/features/api-calls">
