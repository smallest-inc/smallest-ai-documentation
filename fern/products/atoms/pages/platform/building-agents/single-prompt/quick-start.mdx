...
For detailed guidance on writing great prompts, see [Writing Prompts](/voice-agents/platform/create-agent/prompt).
...
<CardGroup cols={2}>
  ...
  <Card title="Set Up Phone Number" icon="phone" href="/voice-agents/platform/deploy/phone-numbers">
