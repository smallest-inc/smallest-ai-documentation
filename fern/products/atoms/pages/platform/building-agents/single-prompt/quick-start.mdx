...
<CardGroup cols={2}>
  ...
  <Card title="Set Up Phone Number" icon="phone" href="/atoms/atoms-platform/deployment/phone-numbers/buying">
    Get a number customers can call
  </Card>
  <Card title="Add Variables" icon="brackets-curly" href="/atoms/atoms-platform/features/variables/what-are-variables">
    Personalize with customer data
  </Card>
  <Card title="Connect APIs" icon="bolt" href="/atoms/atoms-platform/features/api-calls/what-are-api-calls">
