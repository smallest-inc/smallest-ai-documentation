...
<CardGroup cols={2}>
  ...
  <Card title="Add Variables" icon="brackets-curly" href="/atoms/atoms-platform/features/variables">
    Personalize with customer data
  </Card>
  <Card title="Connect APIs" icon="bolt" href="/atoms/atoms-platform/features/api-calls">
