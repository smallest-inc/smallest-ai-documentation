...
For detailed guidance on writing great prompts, see [Writing Prompts](/voice-agents/build/prompt).
...
<CardGroup cols={2}>
  ...
  <Card title="Set Up Phone Number" icon="phone" href="/voice-agents/telephony/phone-numbers">
    Get a number customers can call
  </Card>
  <Card title="Add Variables" icon="brackets-curly" href="/voice-agents/build/variables">
    Personalize with customer data
  </Card>
  <Card title="Connect APIs" icon="bolt" href="/voice-agents/build/api-calls">
