...
→ [Full editor guide](/voice-agents/platform/create-agent/get-started)
...
<CardGroup cols={3}>
  <Card title="Creating" icon="plus" href="/voice-agents/platform/create-agent/get-started">
    Set up your agent
  </Card>
  <Card title="Configuring" icon="sliders" href="/voice-agents/platform/create-agent/get-started">
