...
→ [Full editor guide](/voice-agents/platform/single-prompt-agents/overview)
...
<CardGroup cols={3}>
  <Card title="Creating" icon="plus" href="/voice-agents/platform/single-prompt-agents/creating-your-agent/manual-setup">
    Set up your agent
  </Card>
  <Card title="Configuring" icon="sliders" href="/voice-agents/platform/single-prompt-agents/overview">
    Voice, model, tools & more
  </Card>
  <Card title="Testing" icon="vial" href="/voice-agents/platform/monitor/evaluations">
