...
<CardGroup cols={3}>
  <Card title="Creating" icon="plus" href="/atoms/atoms-platform/single-prompt-agents/creating-your-agent/manual-setup">
    Set up your agent
  </Card>
  <Card title="Configuring" icon="sliders" href="/atoms/atoms-platform/single-prompt-agents/overview">
    Voice, model, tools & more
  </Card>
  <Card title="Testing" icon="vial" href="/atoms/atoms-platform/analytics-logs/testing">
