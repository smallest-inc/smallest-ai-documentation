...
→ [Full editor guide](/voice-agents/build/get-started)
...
<CardGroup cols={3}>
  <Card title="Creating" icon="plus" href="/voice-agents/build/get-started">
    Set up your agent
  </Card>
  <Card title="Configuring" icon="sliders" href="/voice-agents/build/get-started">
    Voice, model, tools & more
  </Card>
  <Card title="Testing" icon="vial" href="/voice-agents/operate/evaluations">
