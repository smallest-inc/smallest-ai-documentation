...
→ Learn more: [Model Selection](/atoms/atoms-platform/single-prompt-agents/agent-settings/model-selection)
...
→ Learn more: [Voice Selection](/atoms/atoms-platform/single-prompt-agents/agent-settings/voice-selection)
...
→ Learn more: [Language Selection](/atoms/atoms-platform/single-prompt-agents/agent-settings/language-selection)
...
|---------|--------------|------------|
| **End Call** | Define when/how AI ends calls | [End Call →](/atoms/atoms-platform/single-prompt-agents/agent-settings/end-call) |
| **Transfer Call** | Set up human handoffs | [Transfer Call →](/atoms/atoms-platform/single-prompt-agents/agent-settings/transfer-call) |
| **Knowledge Base** | Attach reference documents | [Knowledge Base →](/atoms/atoms-platform/single-prompt-agents/agent-settings/knowledge-base) |
...
| **API Calls** | Connect external services | [API Calls →](/atoms/atoms-platform/single-prompt-agents/agent-settings/api-calls) |
...
→ Learn more: [Testing Your Agent](/atoms/atoms-platform/analytics-and-logs/testing)
...
<CardGroup cols={2}>
  ...
  <Card title="Deploy to Phone" icon="phone" href="/atoms/atoms-platform/deployment/phone-numbers/getting-number">
