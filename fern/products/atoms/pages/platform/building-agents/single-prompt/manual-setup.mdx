...
→ Learn more: [Model Selection](/voice-agents/build/prompt)
...
→ Learn more: [Voice Selection](/voice-agents/build/prompt)
...
→ Learn more: [Language Selection](/voice-agents/build/agent-settings)
...
→ Deep dive: [Writing Effective Prompts](/voice-agents/build/prompt)
...
|---------|--------------|------------|
| **End Call** | Define when/how AI ends calls | [End Call →](/voice-agents/build/agent-settings) |
| **Transfer Call** | Set up human handoffs | [Transfer Call →](/voice-agents/build/agent-settings) |
| **Knowledge Base** | Attach reference documents | [Knowledge Base →](/voice-agents/build/agent-settings) |
| **Variables** | Use dynamic values in prompts | [Variables →](/voice-agents/build/agent-settings) |
| **API Calls** | Connect external services | [API Calls →](/voice-agents/build/agent-settings) |
...
→ Learn more: [Testing Your Agent](/voice-agents/operate/evaluations)
...
<CardGroup cols={2}>
  <Card title="Refine Your Prompt" icon="pen" href="/voice-agents/build/prompt">
    Master prompt engineering
  </Card>
  <Card title="Configure Settings" icon="sliders" href="/voice-agents/build/get-started">
    Voice, model, webhooks & more
  </Card>
  <Card title="Add Knowledge Base" icon="book" href="/voice-agents/build/agent-settings">
    Give your agent reference docs
  </Card>
  <Card title="Deploy to Phone" icon="phone" href="/voice-agents/telephony/phone-numbers">
