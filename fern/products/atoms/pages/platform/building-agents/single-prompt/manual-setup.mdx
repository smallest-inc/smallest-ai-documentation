...
→ Learn more: [Testing Your Agent](/atoms/atoms-platform/monitor/evaluations)
...
<CardGroup cols={2}>
  ...
  <Card title="Configure Settings" icon="sliders" href="/atoms/atoms-platform/single-prompt-agents/overview">
    Voice, model, webhooks & more
  </Card>
  <Card title="Add Knowledge Base" icon="book" href="/atoms/atoms-platform/single-prompt-agents/configuration-panel/knowledge-base">
