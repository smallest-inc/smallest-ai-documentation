...
→ Learn more: [Model Selection](/voice-agents/platform/single-prompt-agents/prompt-section/model-selection)
...
→ Learn more: [Voice Selection](/voice-agents/platform/single-prompt-agents/prompt-section/voice-selection)
...
→ Learn more: [Language Selection](/voice-agents/platform/single-prompt-agents/agent-settings/language-selection)
...
→ Deep dive: [Writing Effective Prompts](/voice-agents/platform/single-prompt-agents/prompt-section/writing-prompts)
...
|---------|--------------|------------|
| **End Call** | Define when/how AI ends calls | [End Call →](/voice-agents/platform/single-prompt-agents/configuration-panel/end-call) |
| **Transfer Call** | Set up human handoffs | [Transfer Call →](/voice-agents/platform/single-prompt-agents/configuration-panel/transfer-call) |
| **Knowledge Base** | Attach reference documents | [Knowledge Base →](/voice-agents/platform/single-prompt-agents/configuration-panel/knowledge-base) |
| **Variables** | Use dynamic values in prompts | [Variables →](/voice-agents/platform/single-prompt-agents/configuration-panel/variables) |
| **API Calls** | Connect external services | [API Calls →](/voice-agents/platform/single-prompt-agents/configuration-panel/api-calls) |
...
→ Learn more: [Testing Your Agent](/voice-agents/platform/monitor/evaluations)
...
<CardGroup cols={2}>
  <Card title="Refine Your Prompt" icon="pen" href="/voice-agents/platform/single-prompt-agents/prompt-section/writing-prompts">
    Master prompt engineering
  </Card>
  <Card title="Configure Settings" icon="sliders" href="/voice-agents/platform/single-prompt-agents/overview">
    Voice, model, webhooks & more
  </Card>
  <Card title="Add Knowledge Base" icon="book" href="/voice-agents/platform/single-prompt-agents/configuration-panel/knowledge-base">
