...
→ Learn more: [Model Selection](/voice-agents/platform/create-agent/prompt)
...
→ Learn more: [Voice Selection](/voice-agents/platform/create-agent/prompt)
...
→ Learn more: [Language Selection](/voice-agents/platform/create-agent/agent-config)
...
→ Deep dive: [Writing Effective Prompts](/voice-agents/platform/create-agent/prompt)
...
|---------|--------------|------------|
| **End Call** | Define when/how AI ends calls | [End Call →](/voice-agents/platform/create-agent/agent-config) |
| **Transfer Call** | Set up human handoffs | [Transfer Call →](/voice-agents/platform/create-agent/agent-config) |
| **Knowledge Base** | Attach reference documents | [Knowledge Base →](/voice-agents/platform/create-agent/agent-config) |
| **Variables** | Use dynamic values in prompts | [Variables →](/voice-agents/platform/create-agent/agent-config) |
| **API Calls** | Connect external services | [API Calls →](/voice-agents/platform/create-agent/agent-config) |
...
<CardGroup cols={2}>
  ...
  <Card title="Configure Settings" icon="sliders" href="/voice-agents/platform/create-agent/get-started">
    Voice, model, webhooks & more
  </Card>
  <Card title="Add Knowledge Base" icon="book" href="/voice-agents/platform/create-agent/agent-config">
