...
<CardGroup cols={2}>
  <Card title="Creating Your Agent" icon="plus" href="/voice-agents/platform/create-agent/get-started">
    Start building a Single Prompt agent
  </Card>
  <Card title="Conversational Flow: When to Use" icon="diagram-project" href="/voice-agents/platform/create-agent/get-started">
