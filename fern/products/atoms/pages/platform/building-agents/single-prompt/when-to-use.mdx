...
<CardGroup cols={2}>
  <Card title="Creating Your Agent" icon="plus" href="/atoms/atoms-platform/single-prompt-agents/creating-your-agent/manual-setup">
    Start building a Single Prompt agent
  </Card>
  <Card title="Conversational Flow: When to Use" icon="diagram-project" href="/atoms/atoms-platform/conversational-flow-agents/overview">
