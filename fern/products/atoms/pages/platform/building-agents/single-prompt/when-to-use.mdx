...
<CardGroup cols={2}>
  <Card title="Creating Your Agent" icon="plus" href="/voice-agents/platform/single-prompt-agents/creating-your-agent/manual-setup">
    Start building a Single Prompt agent
  </Card>
  <Card title="Conversational Flow: When to Use" icon="diagram-project" href="/voice-agents/platform/conversational-flow-agents/overview">
