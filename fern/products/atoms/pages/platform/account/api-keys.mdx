...
subtitle: "Create, manage, and rotate API keys to authenticate programmatic access to the voice agent platform and Smallest AI models."
description: "Create, manage, and rotate API keys to authenticate programmatic access to the voice agent platform and Smallest AI models."
---
...
agents = client.atoms.agents.list_agents()
```
...
| `429 Too Many Requests` | Rate limit or concurrency ceiling reached | Wait and retry with backoff. See your plan on [Subscription & Plans](/overview/administration/subscription-plans). |

For concurrency limits and rate-limit specifics, see [Concurrency & Limits](/api-reference/concurrency-and-limits) on the models side; the voice agent platform shares the same quota.
