...
For concurrency limits and rate-limit specifics, see [Concurrency & Limits](/waves/api-reference/api-references/concurrency-and-limits) on the models side; the voice agent platform shares the same quota.
