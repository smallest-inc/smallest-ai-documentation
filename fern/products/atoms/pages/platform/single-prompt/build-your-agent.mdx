...
The [Quick start](/voice-agents/quickstart) gets you to a working agent in five minutes. This page is what to reach for after that: the full list of fields on an agent, grouped by how much they matter, in the order you should fill them in.
...
<Steps>
  ...
  <Step title="Prompt">
    ...
    <Card title="Prompt structure and best practices" href="/voice-agents/build/prompt">
...
<AccordionGroup>
  ...
  <Accordion title="Phone number">
    ...
    <Card title="Phone Numbers" href="/voice-agents/telephony/phone-numbers">
  ...
  <Accordion title="Knowledge base">
    ...
    <Card title="Knowledge Base" href="/voice-agents/build/knowledge-base">
...
<Steps>
  ...
  <Step title="Make the revision live">
    ...
    <Card title="Versioning lifecycle" href="/voice-agents/developer-guide/build/agent-crews/versioning-lifecycle">
...
<CardGroup cols={2}>
  <Card title="Test your agent" href="/voice-agents/quickstart#test-your-agent">
    Web call, telephony, and chat test paths.
  </Card>
  <Card title="Deploy to a phone number" href="/voice-agents/telephony/phone-numbers">
    Attach the number and take live calls.
  </Card>
  <Card title="Post-call metrics" href="/voice-agents/build/post-call-metrics">
    Configure what to extract from every completed call.
  </Card>
  <Card title="Webhooks" href="/voice-agents/integrate/webhooks">
    Receive lifecycle events on your own server.
  </Card>
  <Card title="Prefer code? Quickstart Crew CLI" href="/atoms/developer-guide/get-started/quickstart">
