...
For **structured, multi-step processes** like lead qualification, appointment booking, or intake forms, consider [Conversational Flow](/platform/convo-flow/overview) instead.
...
|------|----------|--------------|
| **Agent Setup** | Left sidebar | Navigate between [Prompt](/platform/single-prompt/writing-prompts), [Agent Settings](/platform/single-prompt/config/voice-settings), [Widget](/platform/features/widget), [Integrations](/platform/features/integrations), [Post Call Metrics](/platform/features/post-call-metrics) |
| **[Prompt Section](/platform/single-prompt/writing-prompts)** | Top bar | Model, voice, and language dropdowns |
| **Prompt Editor** | Center | Where you [write your agent's instructions](/platform/single-prompt/writing-prompts) |
| **[Configuration Panel](/platform/single-prompt/config/end-call)** | Right sidebar | End Call, Transfer Call, Knowledge Base, Variables, API Calls |
| **Actions** | Top right | [Convo Logs](/platform/analytics/conversation-logs), [Lock Agent](/platform/analytics/locking), [Test Agent](/platform/analytics/testing) |
...
<CardGroup cols={3}>
  <Card title="Start from Scratch" icon="plus" href="/platform/single-prompt/manual-setup">
    Blank canvas with full control over every setting
  </Card>
  <Card title="Start with Template" icon="grid-2" href="/platform/single-prompt/from-template">
    Pre-built prompts for common use cases
  </Card>
  <Card title="Create with AI" icon="sparkles" href="/platform/single-prompt/ai-assisted">
