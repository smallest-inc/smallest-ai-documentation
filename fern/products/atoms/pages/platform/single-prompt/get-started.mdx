...
slug: /voice-agents/platform/create-agent/get-started
---
  ...
  <Tab title="Start from Scratch">
    ...
    <Steps>
      ...
      <Step title="Write Your Prompt">
        ...
        <Tip>
        First time? Start simple. Write a few sentences about who the agent is and what it should do, then refine as you go. See the [Prompt page](/voice-agents/platform/create-agent/prompt) for structure and best practices.
        </Tip>
      </Step>
    </Steps>
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Write Your Prompt" icon="pen" href="/voice-agents/platform/create-agent/prompt">
  ...
  <Card title="Add Knowledge Base" icon="book" href="/voice-agents/platform/create-agent/knowledge-base">
