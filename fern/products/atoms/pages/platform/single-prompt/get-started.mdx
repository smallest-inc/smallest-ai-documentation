  ...
  <Tab title="Start from Scratch">
    ...
    <Steps>
      ...
      <Step title="Write Your Prompt">
        ...
        <Tip>
        First time? Start simple. Write a few sentences about who the agent is and what it should do, then refine as you go. See the [Prompt page](/voice-agents/build/prompt) for structure and best practices.
        </Tip>
      </Step>
    </Steps>
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Write Your Prompt" icon="pen" href="/voice-agents/build/prompt">
    Structure, persona, tools, and best practices
  </Card>
  <Card title="Configure Settings" icon="gear" href="/voice-agents/build/agent-settings">
