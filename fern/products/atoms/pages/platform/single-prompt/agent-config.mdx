...
Assigns a phone number to your agent so calls to that number reach it. You can assign more than one number to the same agent. See [Phone Numbers](/voice-agents/platform/deploy/phone-numbers) to purchase or configure numbers.
