...
<Tabs>
  <Tab title="User Defined">
    <Frame caption="User Defined variables">
      ![User defined variables](../../building-agents/images/variables-user.png)
    </Frame>
  ...
  <Tab title="System">
    <Frame caption="System variables">
      ![System variables](../../building-agents/images/variables-system.png)
    </Frame>
  ...
  <Tab title="API">
    <Frame caption="API variables">
      ![API variables](../../building-agents/images/variables-api.png)
    </Frame>
    ...
    → See [API Calls](/platform/single-prompt/config/api-calls)
  </Tab>
</Tabs>
...
<CardGroup cols={2}>
  ...
  <Card title="Writing Prompts" icon="pen" href="/platform/single-prompt/writing-prompts">
