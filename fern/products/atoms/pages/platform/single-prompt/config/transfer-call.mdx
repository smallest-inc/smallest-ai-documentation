...
<Frame caption="Add Transfer Call modal">
  ![Transfer call modal](../../building-agents/images/transfer-call-modal.png)
</Frame>
...
<Frame caption="Warm transfer options">
  ![Warm transfer options](../../building-agents/images/transfer-call-warm.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Webhooks" icon="webhook" href="/atoms/atoms-platform/single-prompt-agents/agent-settings/webhooks">
