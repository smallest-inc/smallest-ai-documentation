...
<CardGroup cols={2}>
  <Card title="Transfer Call" icon="phone-arrow-right" href="/platform/single-prompt/config/transfer-call">
    Hand off to human agents
  </Card>
  <Card title="General Settings" icon="gear" href="/platform/single-prompt/config/general-settings">
