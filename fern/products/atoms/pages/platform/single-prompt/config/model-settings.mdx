...
You can also set the model in the [Prompt Section](/platform/single-prompt/config/model-selection) dropdown at the top of the editor.
...
<CardGroup cols={2}>
  <Card title="Voice Settings" icon="volume" href="/platform/single-prompt/config/voice-settings">
