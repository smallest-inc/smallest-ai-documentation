...
<Frame caption="The Voice Settings tab">
  ![Voice settings](../../building-agents/images/voice-settings.png)
</Frame>
...
<Frame caption="Add Pronunciation modal">
  ![Add pronunciation](../../building-agents/images/add-pronunciation.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Model Settings" icon="microchip" href="/platform/single-prompt/config/model-settings">
    Configure AI model and language behavior
  </Card>
  <Card title="Voice Selection" icon="waveform" href="/platform/single-prompt/config/voice-selection">
