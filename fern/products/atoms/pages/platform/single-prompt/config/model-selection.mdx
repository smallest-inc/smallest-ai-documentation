...
<Frame caption="Model selection dropdown">
  ![Model dropdown](../../building-agents/images/model-dropdown.png)
</Frame>
...
<CardGroup cols={2}>
  ...
  <Card title="Model Settings" icon="sliders" href="/atoms/atoms-platform/single-prompt-agents/agent-settings/model-settings">
