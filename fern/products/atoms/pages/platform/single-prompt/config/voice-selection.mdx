...
<CardGroup cols={2}>
  <Card title="Voice Settings" icon="sliders" href="/platform/single-prompt/config/voice-settings">
    Speed, pronunciation & turn-taking
  </Card>
  <Card title="Language Selection" icon="globe" href="/platform/single-prompt/config/language-selection">
