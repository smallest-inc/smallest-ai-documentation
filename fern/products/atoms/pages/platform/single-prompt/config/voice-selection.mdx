...
<Frame caption="The Voice Picker">
  ![Voice picker](../../building-agents/images/voice-picker.png)
</Frame>
...
<CardGroup cols={2}>
  <Card title="Voice Settings" icon="sliders" href="/atoms/atoms-platform/single-prompt-agents/agent-settings/voice-settings">
    Speed, pronunciation & turn-taking
  </Card>
  <Card title="Language Selection" icon="globe" href="/atoms/atoms-platform/single-prompt-agents/agent-settings/language-selection">
