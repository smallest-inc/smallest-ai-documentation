...
<CardGroup cols={2}>
  <Card title="Agent Config" icon="gear" href="/voice-agents/platform/create-agent/agent-config">
    End call, transfers, knowledge base, and every other setting
  </Card>
  <Card title="Prompt Writing Guide" icon="book" href="/voice-agents/developer-guide/build/agent-crews/llm/prompts">
