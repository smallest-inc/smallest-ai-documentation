...
See [Agent Config](/voice-agents/platform/create-agent/agent-config) for more on Variables.
...
<CardGroup cols={2}>
  <Card title="Campaigns" icon="bullhorn" href="/voice-agents/platform/deployment/campaigns">
