...
<Note>
Creating campaigns over the API instead? **Max Retries** and **Retry Delay** map
...
<Tabs>
  <Tab title="Call Logs">
    ...
    Individual call records for this campaign. Same interface as [Conversation Logs](/voice-agents/operate/conversation-logs)-click any call to see the full transcript, events, and metrics.
  </Tab>
