...
<Tabs>
  <Tab title="Call Logs">
    ...
    Individual call records for this campaign. Same interface as [Conversation Logs](/atoms/atoms-platform/analytics-and-logs/conversation-logs)—click any call to see the full transcript, events, and metrics.
  </Tab>
