...
<Tabs>
  <Tab title="Call Logs">
    ...
    Individual call records for this campaign. Same interface as [Conversation Logs](/voice-agents/platform/monitor/conversation-logs)—click any call to see the full transcript, events, and metrics.
  </Tab>
...
<CardGroup cols={2}>
  <Card title="Audiences" icon="users" href="/voice-agents/platform/deployment/audiences">
