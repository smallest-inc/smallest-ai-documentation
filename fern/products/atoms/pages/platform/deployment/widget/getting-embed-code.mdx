...
→ See: [Widget Configuration](/voice-agents/build/widget)
...
<CardGroup cols={2}>
  <Card title="Adding to Website" icon="browser" href="/voice-agents/build/widget">
    Install the widget
  </Card>
  <Card title="Widget Configuration" icon="sliders" href="/voice-agents/build/widget">
