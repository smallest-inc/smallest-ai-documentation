...
→ See: [Widget Configuration](/voice-agents/platform/features/widget)
...
<CardGroup cols={2}>
  <Card title="Adding to Website" icon="browser" href="/voice-agents/platform/features/widget">
    Install the widget
  </Card>
  <Card title="Widget Configuration" icon="sliders" href="/voice-agents/platform/features/widget">
