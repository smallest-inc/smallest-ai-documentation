...
Configure these on the agent under **Configuration Panel**. [End Call](/voice-agents/platform/single-prompt-agents/configuration-panel/end-call), [Transfer Call](/voice-agents/platform/single-prompt-agents/configuration-panel/transfer-call).
