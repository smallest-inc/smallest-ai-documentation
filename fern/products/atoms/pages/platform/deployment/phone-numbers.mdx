...
Configure these on the agent under **Configuration Panel** — [End Call](/atoms/atoms-platform/single-prompt-agents/configuration-panel/end-call), [Transfer Call](/atoms/atoms-platform/single-prompt-agents/configuration-panel/transfer-call).

---

## SIP Providers

Atoms works with any provider that supports standard SIP trunking. Common choices:
...
| **Your own PBX / VoIP** | Any provider that speaks SIP works — provide your termination URL and Atoms handles the rest |

Atoms routes outbound calls to your SIP termination URL and gives you an **Origination URL** to configure in your provider so inbound calls reach your agent.
...
<CardGroup cols={2}>
  <Card title="Audiences" icon="users" href="/atoms/atoms-platform/deploy/audiences">
    Manage contact lists for campaigns
  </Card>
  <Card title="Campaigns" icon="bullhorn" href="/atoms/atoms-platform/deploy/campaigns">
