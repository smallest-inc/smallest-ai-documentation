...
<CardGroup cols={2}>
  <Card title="Using with Campaigns" icon="megaphone" href="/atoms/atoms-platform/deployment/audiences/using-with-campaigns">
    Connect to campaigns
  </Card>
  <Card title="Creating a Campaign" icon="plus" href="/atoms/atoms-platform/deployment/campaigns/creating-campaign">
    Start calling
  </Card>
</CardGroup>
