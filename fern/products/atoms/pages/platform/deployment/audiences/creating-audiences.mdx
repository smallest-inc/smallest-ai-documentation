...
<CardGroup cols={2}>
  <Card title="Using with Campaigns" icon="megaphone" href="/voice-agents/platform/deployment/audiences">
    Connect to campaigns
  </Card>
  <Card title="Creating a Campaign" icon="plus" href="/voice-agents/platform/deployment/campaigns">
    Start calling
  </Card>
</CardGroup>
