...
→ See: [Phone Numbers](/voice-agents/platform/deploy/phone-numbers)
...
→ See: [Campaigns](/voice-agents/platform/deploy/campaigns)
...
<CardGroup cols={2}>
  <Card title="Getting a Number" icon="phone" href="/voice-agents/platform/deploy/phone-numbers">
