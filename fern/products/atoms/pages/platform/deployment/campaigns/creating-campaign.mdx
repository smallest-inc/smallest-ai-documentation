...
→ See: [Creating Audiences](/voice-agents/platform/deployment/audiences)
...
<CardGroup cols={2}>
  <Card title="Managing Contacts" icon="users" href="/voice-agents/platform/deployment/campaigns">
    Work with campaign contacts
  </Card>
  <Card title="Campaign Analytics" icon="chart-bar" href="/voice-agents/platform/deployment/campaigns">
    Track performance
  </Card>
</CardGroup>
