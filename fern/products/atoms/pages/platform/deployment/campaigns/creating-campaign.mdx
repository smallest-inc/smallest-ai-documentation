...
→ See: [Creating Audiences](/voice-agents/platform/deploy/audiences)
...
<CardGroup cols={2}>
  <Card title="Managing Contacts" icon="users" href="/voice-agents/platform/deploy/campaigns">
    Work with campaign contacts
  </Card>
  <Card title="Campaign Analytics" icon="chart-bar" href="/voice-agents/platform/deploy/campaigns">
    Track performance
  </Card>
</CardGroup>
