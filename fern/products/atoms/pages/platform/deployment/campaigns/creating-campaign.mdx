...
→ See: [Creating Audiences](/voice-agents/telephony/audiences)
...
<CardGroup cols={2}>
  <Card title="Managing Contacts" icon="users" href="/voice-agents/telephony/campaigns">
    Work with campaign contacts
  </Card>
  <Card title="Campaign Analytics" icon="chart-bar" href="/voice-agents/telephony/campaigns">
    Track performance
  </Card>
</CardGroup>
