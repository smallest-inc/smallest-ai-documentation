...
<CardGroup cols={2}>
  <Card title="Managing Contacts" icon="users" href="/atoms/atoms-platform/deployment/campaigns/managing-contacts">
    Work with campaign contacts
  </Card>
  <Card title="Campaign Analytics" icon="chart-bar" href="/atoms/atoms-platform/deployment/campaigns/campaign-analytics">
    Track performance
  </Card>
</CardGroup>
