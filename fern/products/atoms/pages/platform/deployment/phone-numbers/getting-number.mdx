...
<CardGroup cols={2}>
  <Card title="Configuring Inbound" icon="phone-arrow-down" href="/voice-agents/telephony/phone-numbers">
    Set up call handling
  </Card>
  <Card title="Managing Numbers" icon="list" href="/voice-agents/telephony/phone-numbers">
