...
<CardGroup cols={2}>
  <Card title="Configuring Inbound" icon="phone-arrow-down" href="/atoms/atoms-platform/deployment/phone-numbers/configuring-inbound">
    Set up call handling
  </Card>
  <Card title="Managing Numbers" icon="list" href="/atoms/atoms-platform/deployment/phone-numbers/managing-numbers">
