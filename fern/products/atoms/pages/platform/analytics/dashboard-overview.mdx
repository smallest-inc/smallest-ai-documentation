...
<CardGroup cols={2}>
  <Card title="Understanding Metrics" icon="chart-line" href="/atoms/atoms-platform/analytics-and-logs/understanding-metrics">
    Deep dive into metrics
  </Card>
  <Card title="Improving Performance" icon="arrow-trend-up" href="/atoms/atoms-platform/analytics-and-logs/improving-performance">
    Optimization tips
  </Card>
</CardGroup>
