...
<CardGroup cols={2}>
  <Card title="Understanding Metrics" icon="chart-line" href="/atoms/atoms-platform/analytics-logs/overview">
    Deep dive into metrics
  </Card>
  <Card title="Improving Performance" icon="arrow-trend-up" href="/atoms/atoms-platform/analytics-logs/overview">
    Optimization tips
  </Card>
</CardGroup>
