...
<CardGroup cols={2}>
  <Card title="Get Started with Create Agent" icon="rocket" href="/atoms/atoms-platform/create-agent/get-started">
    Everything on creating an agent, from templates to building from scratch
  </Card>
  <Card title="Refine Your Prompt" icon="pen" href="/atoms/atoms-platform/create-agent/prompt">
