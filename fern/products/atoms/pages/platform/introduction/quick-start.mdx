...
<Frame caption="Testing your agent with a web call — the agent responds in real-time while you speak">
  <img src="../../images/test-agent-web-call.png" alt="Atoms platform test agent dialog showing a web call in progress with the agent speaking" />
</Frame>
