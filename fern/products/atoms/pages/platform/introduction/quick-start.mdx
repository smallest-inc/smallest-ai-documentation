...
<Frame caption="Atom Voice Agent Platform Agents Page">
  <img src="../../images/app.smallest.ai_welcome_screen_atoms-platform.png.png" alt="Agents page for atom voice agent platform" />
</Frame>

Navigate to the Agents section to create and manage your voice agents.

<Frame caption="Atom Voice Agent Platform Home Dashboard">
  <img src="../../images/app.smallest.ai_welcome_screen_atoms-platform_2.png" alt="Home dashboard for atom voice agent platform" />
</Frame>
---
...
<Card title="How Single Prompt Agents Work" icon="message" href="/atoms/atoms-platform/single-prompt-agents/overview">
  How one prompt powers an entire conversation.
</Card>
