...
<Card title="Refine Your Prompt" href="/voice-agents/build/prompt">
  Structure and improve your agent's instructions
</Card>
<CardGroup cols={2}>
  <Card title="Deploy to Phone" href="/voice-agents/telephony/phone-numbers">
    Get a real phone number and go live
  </Card>
  <Card title="Configure Settings" href="/voice-agents/build/agent-settings">
