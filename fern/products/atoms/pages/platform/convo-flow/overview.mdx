...
For **open-ended, flexible conversations** like general support or FAQs, consider [Single Prompt](/platform/single-prompt/overview) instead.
...
<CardGroup cols={2}>
  <Card title="Start from Scratch" icon="plus" href="/platform/convo-flow/manual-setup">
    Blank canvas with full control over your workflow
  </Card>
  <Card title="Start with Template" icon="grid-2" href="/platform/convo-flow/from-template">
