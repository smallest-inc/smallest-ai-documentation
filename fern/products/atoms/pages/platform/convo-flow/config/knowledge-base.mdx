...
<CardGroup cols={2}>
  <Card title="Model Settings" icon="microchip" href="/platform/convo-flow/config/model-settings">
    Global Prompt and model configuration
  </Card>
  <Card title="Knowledge Base Guide" icon="book" href="/platform/features/knowledge-base">
