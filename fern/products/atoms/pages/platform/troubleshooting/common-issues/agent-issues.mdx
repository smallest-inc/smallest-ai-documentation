...
<CardGroup cols={2}>
  <Card title="Call Quality Issues" icon="phone-slash" href="/voice-agents/platform/troubleshooting/common-issues/call-quality">
    Audio and connection problems
  </Card>
  <Card title="Configuration Issues" icon="gear" href="/voice-agents/platform/troubleshooting/common-issues/configuration">
