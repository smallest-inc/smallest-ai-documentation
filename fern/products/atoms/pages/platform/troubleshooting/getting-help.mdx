...
<CardGroup cols={2}>
  ...
  <Card title="Voice Agent Showcase" icon="globe" href="https://showcase.smallest.ai/">
...
<CardGroup cols={3}>
  <Card title="Documentation" icon="book" href="/voice-agents/platform/get-started/quick-start">
  ...
  <Card title="FAQ" icon="circle-question" href="/voice-agents/platform/troubleshooting/faq">
