...
→ See: [Widget Deployment](/voice-agents/platform/features/widget) for embedding instructions
...
<CardGroup cols={2}>
  ...
  <Card title="Integrations" icon="link" href="/voice-agents/platform/features/integrations">
