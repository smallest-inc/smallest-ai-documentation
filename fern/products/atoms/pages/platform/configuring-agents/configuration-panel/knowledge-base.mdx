...
→ See: [Knowledge Base Features](/voice-agents/build/knowledge-base) for creating and managing KBs
...
→ See: [Creating a Knowledge Base](/voice-agents/build/knowledge-base)
...
<CardGroup cols={2}>
  <Card title="Variables" icon="brackets-curly" href="/voice-agents/build/agent-settings">
    Add dynamic values to prompts
  </Card>
  <Card title="Knowledge Base Features" icon="book" href="/voice-agents/build/knowledge-base">
