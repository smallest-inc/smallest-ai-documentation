...
→ See: [Knowledge Base Features](/voice-agents/platform/features/knowledge-base) for creating and managing KBs
...
→ See: [Creating a Knowledge Base](/voice-agents/platform/features/knowledge-base)
...
<CardGroup cols={2}>
  <Card title="Variables" icon="brackets-curly" href="/voice-agents/platform/single-prompt-agents/configuration-panel/variables">
    Add dynamic values to prompts
  </Card>
  <Card title="Knowledge Base Features" icon="book" href="/voice-agents/platform/features/knowledge-base">
