...
→ See: [Variables Reference](/voice-agents/build/variables) for complete list
...
<CardGroup cols={2}>
  <Card title="API Calls" icon="cloud" href="/voice-agents/build/agent-settings">
    Fetch dynamic data
  </Card>
  <Card title="Variables Reference" icon="list" href="/voice-agents/build/variables">
