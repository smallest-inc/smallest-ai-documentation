...
→ See: [Variables Reference](/voice-agents/platform/features/variables) for complete list
...
<CardGroup cols={2}>
  <Card title="API Calls" icon="cloud" href="/voice-agents/platform/single-prompt-agents/configuration-panel/api-calls">
    Fetch dynamic data
  </Card>
  <Card title="Variables Reference" icon="list" href="/voice-agents/platform/features/variables">
