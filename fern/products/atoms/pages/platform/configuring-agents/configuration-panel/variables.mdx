...
→ See: [Variables Reference](/atoms/atoms-platform/features/variables) for complete list
...
<CardGroup cols={2}>
  <Card title="API Calls" icon="cloud" href="/atoms/atoms-platform/single-prompt-agents/configuration-panel/api-calls">
    Fetch dynamic data
  </Card>
  <Card title="Variables Reference" icon="list" href="/atoms/atoms-platform/features/variables">
