...
→ See: [Node Types Reference](/voice-agents/platform/conversational-flow-agents/workflow-tab/node-types)
...
<CardGroup cols={2}>
  <Card title="API Calls Reference" icon="book" href="/voice-agents/platform/features/api-calls">
