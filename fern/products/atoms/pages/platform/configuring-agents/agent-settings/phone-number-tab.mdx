...
→ See: [Getting a Number](/voice-agents/platform/deploy/phone-numbers)
...
<CardGroup cols={2}>
  <Card title="Webhook Tab" icon="webhook" href="/voice-agents/platform/create-agent/agent-config">
