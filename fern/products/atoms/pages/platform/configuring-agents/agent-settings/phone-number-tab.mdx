...
→ See: [Getting a Number](/voice-agents/platform/deployment/phone-numbers)
...
<CardGroup cols={2}>
  <Card title="Webhook Tab" icon="webhook" href="/voice-agents/platform/single-prompt-agents/agent-settings/webhooks">
