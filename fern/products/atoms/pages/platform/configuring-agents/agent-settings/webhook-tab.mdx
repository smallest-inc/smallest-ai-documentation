...
→ See: [Creating Endpoints](/voice-agents/platform/features/webhooks)
...
→ See: [Webhook Use Cases](/voice-agents/platform/features/webhooks) for common patterns
...
<CardGroup cols={2}>
  <Card title="General Tab" icon="gear" href="/voice-agents/platform/single-prompt-agents/agent-settings/general-settings">
    Timeout settings
  </Card>
