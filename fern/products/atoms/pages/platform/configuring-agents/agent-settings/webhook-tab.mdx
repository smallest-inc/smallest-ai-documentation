...
→ See: [Creating Endpoints](/voice-agents/integrate/webhooks)
...
→ See: [Webhook Use Cases](/voice-agents/integrate/webhooks) for common patterns
...
<CardGroup cols={2}>
  <Card title="General Tab" icon="gear" href="/voice-agents/build/agent-settings">
    Timeout settings
  </Card>
