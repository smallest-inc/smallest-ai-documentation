...
→ See: [Model Tab](/voice-agents/build/agent-settings) for language switching configuration
...
<CardGroup cols={2}>
  <Card title="End Call Configuration" icon="phone-slash" href="/voice-agents/build/agent-settings">
    Configure call termination
  </Card>
  <Card title="Model Tab" icon="brain" href="/voice-agents/build/agent-settings">
