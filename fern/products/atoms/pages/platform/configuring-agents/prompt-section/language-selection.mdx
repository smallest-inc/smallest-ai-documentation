...
→ See: [Model Tab](/voice-agents/platform/single-prompt-agents/agent-settings/model-settings) for language switching configuration
...
<CardGroup cols={2}>
  <Card title="End Call Configuration" icon="phone-slash" href="/voice-agents/platform/single-prompt-agents/configuration-panel/end-call">
    Configure call termination
  </Card>
  <Card title="Model Tab" icon="brain" href="/voice-agents/platform/single-prompt-agents/agent-settings/model-settings">
