...
→ See: [Model Tab](/voice-agents/platform/create-agent/agent-config) for language switching configuration
...
<CardGroup cols={2}>
  <Card title="End Call Configuration" icon="phone-slash" href="/voice-agents/platform/create-agent/agent-config">
    Configure call termination
  </Card>
  <Card title="Model Tab" icon="brain" href="/voice-agents/platform/create-agent/agent-config">
