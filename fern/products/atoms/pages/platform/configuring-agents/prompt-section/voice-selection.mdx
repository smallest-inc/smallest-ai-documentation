...
<CardGroup cols={2}>
  <Card title="Language Selection" icon="globe" href="/voice-agents/build/agent-settings">
    Set primary language
  </Card>
  <Card title="Voice Tab Settings" icon="sliders" href="/voice-agents/build/agent-settings">
