...
→ See: [Model Selection](/atoms/atoms-platform/single-prompt-agents/prompt-section/model-selection), [Voice Selection](/atoms/atoms-platform/single-prompt-agents/prompt-section/voice-selection), [Language Selection](/atoms/atoms-platform/single-prompt-agents/agent-settings/language-selection)
...
<CardGroup cols={2}>
  <Card title="Model Selection" icon="brain" href="/atoms/atoms-platform/single-prompt-agents/prompt-section/model-selection">
    Choose your LLM
  </Card>
