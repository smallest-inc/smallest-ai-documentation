...
→ See: [Model Selection](/voice-agents/platform/single-prompt-agents/prompt-section/model-selection), [Voice Selection](/voice-agents/platform/single-prompt-agents/prompt-section/voice-selection), [Language Selection](/voice-agents/platform/single-prompt-agents/agent-settings/language-selection)
...
→ See: [Voice Tab](/voice-agents/platform/single-prompt-agents/agent-settings/voice-settings), [Model Tab](/voice-agents/platform/single-prompt-agents/agent-settings/model-settings), [Phone Number Tab](/voice-agents/platform/single-prompt-agents/agent-settings/phone-number), [Webhook Tab](/voice-agents/platform/single-prompt-agents/agent-settings/webhooks), [General Tab](/voice-agents/platform/single-prompt-agents/agent-settings/general-settings)
...
<CardGroup cols={2}>
  <Card title="Model Selection" icon="brain" href="/voice-agents/platform/single-prompt-agents/prompt-section/model-selection">
    Choose your LLM
  </Card>
  <Card title="Voice Selection" icon="microphone" href="/voice-agents/platform/single-prompt-agents/prompt-section/voice-selection">
