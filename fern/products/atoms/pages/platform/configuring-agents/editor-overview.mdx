...
→ See: [Model Selection](/voice-agents/build/prompt), [Voice Selection](/voice-agents/build/prompt), [Language Selection](/voice-agents/build/agent-settings)
...
→ See: [End Call](/voice-agents/build/agent-settings), [Transfer Call](/voice-agents/build/agent-settings), [Knowledge Base](/voice-agents/build/agent-settings), [Variables](/voice-agents/build/agent-settings), [API Calls](/voice-agents/build/agent-settings)
...
→ See: [Voice Tab](/voice-agents/build/agent-settings), [Model Tab](/voice-agents/build/agent-settings), [Phone Number Tab](/voice-agents/build/agent-settings), [Webhook Tab](/voice-agents/build/agent-settings), [General Tab](/voice-agents/build/agent-settings)
...
<CardGroup cols={2}>
  <Card title="Model Selection" icon="brain" href="/voice-agents/build/prompt">
    Choose your LLM
  </Card>
  <Card title="Voice Selection" icon="microphone" href="/voice-agents/build/prompt">
