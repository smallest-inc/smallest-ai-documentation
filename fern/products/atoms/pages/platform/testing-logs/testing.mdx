...
<CardGroup cols={2}>
  <Card title="Conversation Logs" icon="file-lines" href="/atoms/atoms-platform/analytics-logs/conversation-logs">
    Debug with detailed logs
  </Card>
  <Card title="Locking Your Agent" icon="lock" href="/atoms/atoms-platform/analytics-logs/locking">
