...
<CardGroup cols={2}>
  <Card title="Conversation Logs" icon="file-lines" href="/voice-agents/operate/conversation-logs">
    Debug with detailed logs
  </Card>
  <Card title="Locking Your Agent" icon="lock" href="/voice-agents/build/versioning">
