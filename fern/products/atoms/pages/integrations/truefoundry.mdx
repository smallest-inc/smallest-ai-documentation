---
title: "TrueFoundry"
description: "Use Smallest AI TTS and STT through TrueFoundry's AI Gateway."
icon: "server"
---

[TrueFoundry](https://www.truefoundry.com) is an ML platform with a built-in AI Gateway that proxies requests to Smallest AI's Waves API. Once configured, you call TTS and STT through your TrueFoundry gateway URL instead of directly — giving you request tracing and centralised access control across your team.
...
![Smallest AI models on the provider account](../../waves/pages/v4.0.0/images/smallest-ai-models.png)
