...
### 2. Can we integrate our systems with the voice agent platform?

Yes, the platform has a very robust API that can be integrated into any software. You can get the full list of APIs [here](/atoms/api-reference).

### 3. What integrations are supported?

Almost every single software can be integrated with an agent - before, during and after a call is complete.
...
Apart from the ones mentioned above, you can also use the [API](/atoms/api-reference) to integrate the platform into any software.
...
### 5. Can I use the platform over chat?

Yes, you can use the platform over chat as well. Please refer to the [API documentation](/atoms/api-reference) to know more.

### 6. How much does it cost?

The cost depends on the volume of usage. It starts at 0.08 USD/min and goes 2-3x lower as you scale in volumes.

You can get the detailed pricing [here](https://smallest.ai/pricing) and it is also explained in depth on the [Subscription & Plans page](/voice-agents/platform/account/subscription-plans).
