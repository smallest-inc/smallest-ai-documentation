...
We primarily support English and Hindi (with English code-switching) for enterprises with extremely robust controls on quality.

Apart from that, we also support German, Spanish, Russian, Italian, French, Dutch, Portuguese, Mandarin, Cantonese, Japanese, Korean, Gujarati, and Marathi. See the [Pulse model card](/waves/model-cards/speech-to-text/pulse) for the full STT language list and the `multi-eu` / `multi-indic` aggregators.
