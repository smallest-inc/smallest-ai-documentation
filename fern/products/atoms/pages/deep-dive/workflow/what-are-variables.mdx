...
Audience variables are created automatically from the columns in your uploaded [Audience CSV](/voice-agents/platform/deploy/audiences) file. Each column header in your CSV becomes a variable name that's accessible throughout your workflow.
