...
2. Add Smallest AI's SIP endpoint as a destination, with **TLS transport** (preferred; TCP is a fallback):
   ```
   sip:5rdbhjuwtlk.sip.livekit.cloud;transport=tls
   ```
...
[
  {
    ...
    "endpoint": [
      {
        "type": "sip",
        "uri": "sip:5rdbhjuwtlk.sip.livekit.cloud;transport=tls"
      }
    ]
  }
]
...
- Check that SIP endpoint URI is correct and carries the transport parameter: `sip:5rdbhjuwtlk.sip.livekit.cloud;transport=tls`
