...
Copy the **SIP origination URL** from your dashboard under **Add phone number → SIP Trunking**. It is a bare SIP URI. The exact host in your dashboard may differ from the example (e.g. `sip:5rdbhjuwtlk.sip.livekit.cloud`); use whatever your field shows:
