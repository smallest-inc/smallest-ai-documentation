...
2. Make an **outbound** test call from the agent (via the dashboard, or [POST /conversation/outbound](/voice-agents/api-reference/calls/create-outbound-call)) to your own phone. Check that your provider bills the call to your termination trunk.
