...
The URL your dashboard shows is a bare SIP URI. Replace `YOUR_SIP_INGRESS` with the value you see under **Phone Numbers → Import SIP Number** in your dashboard:
