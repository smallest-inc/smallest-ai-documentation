...
Navigate to the [Knowledge Base](https://app.smallest.ai/dashboard/knowledge-base) tab in your dashboard to start creating your first KB. Here you can create new knowledge bases and manage existing ones. Simply click the **+** button to create a new one.
