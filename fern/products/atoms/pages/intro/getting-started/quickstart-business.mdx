...
<Steps>
  <Step title="Sign Up & Access Dashboard">
    1. Go to [app.smallest.ai](https://app.smallest.ai)
  ...
  <Step title="Configure Your Agent">
    ...
    **Set the Basics:**
    ...
    <Card title="Learn More" icon="book" href="/atoms/atoms-platform/get-started/platform-overview">
...
<CardGroup cols={2}>
  <Card title="Add Knowledge Base" icon="brain" href="/atoms/atoms-platform/features/knowledge-base">
    Give your agent company-specific knowledge
  </Card>
  <Card title="Launch Campaigns" icon="megaphone" href="/atoms/atoms-platform/deployment/campaigns">
    Make outbound calls at scale
  </Card>
  <Card title="Integrate CRM" icon="link" href="/atoms/atoms-platform/features/integrations">
    Connect to Salesforce, HubSpot, and more
  </Card>
  <Card title="View Analytics" icon="chart-line" href="/atoms/atoms-platform/features/post-call-metrics">
