...
<CardGroup cols={2}>
  <Card title="Add Knowledge Base" icon="brain" href="/atoms/atoms-platform/introduction/add-knowledge-base">
    Give your agent company-specific knowledge
  </Card>
  <Card title="Launch Campaigns" icon="megaphone" href="/atoms/atoms-platform/deployment/campaigns/what-are-campaigns">
    Make outbound calls at scale
  </Card>
  <Card title="Integrate CRM" icon="link" href="/atoms/atoms-platform/features/integrations/overview">
