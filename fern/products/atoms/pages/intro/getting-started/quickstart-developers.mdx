...
- An Atoms account ([sign up here](https://app.smallest.ai))

---

## Step 1: Get Your API Key

1. Log in to your [Atoms Dashboard](https://app.smallest.ai)
...
<CardGroup cols={2}>
  <Card title="SDK Reference" icon="book" href="/atoms/developer-guide/get-started/core-concepts/overview">
    Deep dive into SDK concepts
  </Card>
  <Card title="API Reference" icon="code" href="/atoms/api-reference">
    Full REST API documentation
  </Card>
  <Card title="Knowledge Base API" icon="brain" href="/atoms/developer-guide/build/knowledge-base/usage">
    Add RAG capabilities to agents
  </Card>
  <Card title="Campaigns API" icon="megaphone" href="/atoms/developer-guide/build/campaigns/creating-campaigns">
