...
> Set this up in the [Platform UI](/atoms/atoms-platform/deployment/phone-numbers) or via the [API](/atoms/api-reference/endpoint/post-productimport-phone-number).
