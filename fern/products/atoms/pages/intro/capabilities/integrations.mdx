...
<CardGroup cols={2}>
  <Card title="Platform" icon="browser" href="/atoms/atoms-platform/features/integrations">
    Configure integrations visually
  </Card>
  <Card title="Developer Guide" icon="code" href="/atoms/developer-guide/build/agent-crews/tools/overview">
