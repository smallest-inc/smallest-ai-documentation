...
English, Hindi (with English code-switching), German, Spanish, Russian, Italian, French, Dutch, Portuguese, Mandarin, Cantonese, Japanese, Korean, Gujarati, Marathi — plus `multi-eu` (EU set) and `multi-indic` (Indic set) aggregators.
...
<CardGroup cols={2}>
  ...
  <Card title="Developer Guide" icon="code" href="/atoms/product-overview/capabilities/voice-and-speech">
