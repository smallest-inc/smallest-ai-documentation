...
<Card title="Single Prompt" icon="message" href="/atoms/atoms-platform/single-prompt-agents/overview">
  **One prompt, infinite flexibility.** You define personality and rules — the AI handles the flow. Best for support, FAQs, structured processes like qualification and booking, and open-ended conversations.
</Card>
...
<CardGroup cols={2}>
  <Card title="Platform" icon="browser" href="/atoms/atoms-platform/single-prompt-agents/overview">
    Build agents visually — no code required
  </Card>
  <Card title="Developer Guide" icon="code" href="/atoms/developer-guide/build/agent-crews/overview">
