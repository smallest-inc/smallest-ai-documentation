...
<CardGroup cols={2}>
  <Card title="Platform" icon="browser" href="/atoms/atoms-platform/deployment/campaigns">
    Launch campaigns from the dashboard
  </Card>
  <Card title="Developer Guide" icon="code" href="/atoms/developer-guide/build/campaigns/creating-campaigns">
