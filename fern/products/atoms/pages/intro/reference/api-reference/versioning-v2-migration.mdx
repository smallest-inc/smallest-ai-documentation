...
- **Sunset**: v1 endpoints are removed. **No removal date is published yet.** When the backend owner fixes a date, this page and the [Deprecation Notices](/voice-agents/api-reference/deprecation-notices) page will carry it, and the affected endpoints will start returning a `Sunset:` header (RFC 8594) with an RFC 7231 date.
