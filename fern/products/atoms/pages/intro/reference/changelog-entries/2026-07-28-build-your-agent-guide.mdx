...
Complements the existing [Quick start](/voice-agents/quickstart) (five-minute template walkthrough) and [Agent Settings overview](/voice-agents/build/agent-settings) (deep-dive card index). This page is the "what should I touch and in what order" answer for the middle ground.
