...
Listed on the [Deprecation Notices](/voice-agents/deprecations/notices#widget) page. The `widgetConfig` object on the agent response body is unchanged (safe to ignore for API-only integrations).
