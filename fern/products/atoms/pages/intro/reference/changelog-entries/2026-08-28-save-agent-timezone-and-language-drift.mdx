...
Fixed two drifts on [`PUT /agent/{id}/branches/{branchId}/draft`](/api-reference/voice-agents/agent-versioning-branches/update-branch-draft) that were sending real integrations into hours of 400s.
