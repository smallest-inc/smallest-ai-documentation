...
[SIP Trunking](/voice-agents/telephony/phone-numbers/sip-trunking) is rewritten to document what actually works and to remove guidance that was silently wrong.
