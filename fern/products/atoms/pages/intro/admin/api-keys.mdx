...
**Location:** [console.smallest.ai](https://console.smallest.ai) → API Keys
...
1. Go to [console.smallest.ai](https://console.smallest.ai) → **API Keys**
...
```bash
curl -X GET "https://atoms-api.smallest.ai/api/v1/agent" \
